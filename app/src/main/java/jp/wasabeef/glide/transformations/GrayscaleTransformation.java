...
public class GrayscaleTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f6018ID = "jp.wasabeef.glide.transformations.GrayscaleTransformation.1";
    private static final byte[] ID_BYTES = f6018ID.getBytes(Key.CHARSET);
