...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0037R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
    ...
    private void addID(String str) {
        ...
        if (i == 0) {
            i = this.myContext.getResources().getIdentifier(trim, DatabaseFieldConfigLoader.FIELD_NAME_ID, this.myContext.getPackageName());
        }
