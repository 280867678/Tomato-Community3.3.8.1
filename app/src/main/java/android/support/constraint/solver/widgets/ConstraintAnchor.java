...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (C00401.f5x1d400623[type2.ordinal()]) {
            case 1:
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C00401 {

        /* renamed from: $SwitchMap$android$support$constraint$solver$widgets$ConstraintAnchor$Type */
        static final /* synthetic */ int[] f5x1d400623 = new int[Type.values().length];

        static {
            try {
                f5x1d400623[Type.CENTER.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f5x1d400623[Type.LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5x1d400623[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5x1d400623[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f5x1d400623[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f5x1d400623[Type.BASELINE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f5x1d400623[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f5x1d400623[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f5x1d400623[Type.NONE.ordinal()] = 9;
    ...
    public boolean isSideAnchor() {
        switch (C00401.f5x1d400623[this.mType.ordinal()]) {
            case 1:
            case 6:
            case 7:
            case 8:
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (C00401.f5x1d400623[this.mType.ordinal()]) {
            ...
            case 9:
                return false;
            case 2:
                int i = C00401.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i == 3 || i == 7;
            case 3:
                int i2 = C00401.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i2 == 2 || i2 == 7;
            case 4:
                int i3 = C00401.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i3 == 5 || i3 == 8;
            case 5:
                int i4 = C00401.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i4 == 4 || i4 == 8;
            case 7:
                int i5 = C00401.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i5 == 2 || i5 == 3;
            case 8:
                int i6 = C00401.f5x1d400623[constraintAnchor.getType().ordinal()];
                return i6 == 4 || i6 == 5;
            default:
                throw new AssertionError(this.mType.name());
        }
