...
public class LinearSystem {
    ...
    private Row mGoal = new GoalRow(this.mCache);
    private final Row mTempGoal = new ArrayRow(this.mCache);
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f4id = this.mVariablesID;
