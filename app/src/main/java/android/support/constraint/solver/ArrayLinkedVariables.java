...
public class ArrayLinkedVariables {
    ...
    public final void put(SolverVariable solverVariable, float f) {
        ...
        if (i == -1) {
            ...
            int i2 = this.mHead;
            fArr[i2] = f;
            this.mArrayIndices[i2] = solverVariable.f4id;
        ...
        this.mArrayIndices[i8] = solverVariable.f4id;
    ...
    */
    ...
    public SolverVariable getPivotCandidate(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            if (this.mArrayValues[i] < 0.0f) {
                SolverVariable solverVariable3 = this.mCache.mIndexedVariables[this.mArrayIndices[i]];
                if ((zArr == null || !zArr[solverVariable3.f4id]) && solverVariable3 != solverVariable && ((type = solverVariable3.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR)) {
    ...
    public void display() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                printStream.print(variable + " = " + getVariableValue(i2) + ConstantUtils.PLACEHOLDER_STR_ONE);
            }
        }
        System.out.println(" }");
    }
