...
import android.support.p002v4.widget.Space;
...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = this.context.getResources().getDimensionPixelSize(C0064R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.errorView.setId(C0064R.C0067id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.helperTextView.setId(C0064R.C0067id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
