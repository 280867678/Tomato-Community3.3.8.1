...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0064R.C0069layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C0064R.C0067id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, (ViewGroup) coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C0064R.C0067id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0064R.C0067id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: android.support.design.widget.BottomSheetDialog.1
    ...
    private static int getThemeResId(Context context, int i) {
        if (i == 0) {
            ...
            if (context.getTheme().resolveAttribute(C0064R.attr.bottomSheetDialogTheme, typedValue, true)) {
                return typedValue.resourceId;
            }
            return C0064R.C0070style.Theme_Design_Light_BottomSheetDialog;
        }
        return i;
    }
}
