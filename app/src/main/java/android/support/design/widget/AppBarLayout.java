...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C0064R.C0070style.Widget_Design_AppBarLayout);
        }
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0064R.styleable.AppBarLayout, 0, C0064R.C0070style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(C0064R.styleable.AppBarLayout_android_background));
        if (obtainStyledAttributes.hasValue(C0064R.styleable.AppBarLayout_expanded)) {
            setExpanded(obtainStyledAttributes.getBoolean(C0064R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && obtainStyledAttributes.hasValue(C0064R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, obtainStyledAttributes.getDimensionPixelSize(C0064R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (obtainStyledAttributes.hasValue(C0064R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(obtainStyledAttributes.getBoolean(C0064R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (obtainStyledAttributes.hasValue(C0064R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(obtainStyledAttributes.getBoolean(C0064R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = obtainStyledAttributes.getBoolean(C0064R.styleable.AppBarLayout_liftOnScroll, false);
    ...
    public LayoutParams mo5633generateDefaultLayoutParams() {
        return new LayoutParams(-1, -2);
    }

    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo5636generateLayoutParams(AttributeSet attributeSet) {
    ...
    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo5637generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C0064R.attr.state_liftable : -C0064R.attr.state_liftable;
        iArr[1] = (!this.liftable || !this.lifted) ? -C0064R.attr.state_lifted : C0064R.attr.state_lifted;
        iArr[2] = this.liftable ? C0064R.attr.state_collapsible : -C0064R.attr.state_collapsible;
        iArr[3] = (!this.liftable || !this.lifted) ? -C0064R.attr.state_collapsed : C0064R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.scrollFlags = 1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0064R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C0064R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C0064R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0064R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            obtainStyledAttributes.recycle();
        }
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                animateOffsetTo(coordinatorLayout, t, android.support.p002v4.math.MathUtils.clamp(i, -t.getTotalScrollRange(), 0), 0.0f);
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            setTopAndBottomOffset(android.support.p002v4.math.MathUtils.clamp(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) {
            ...
            if (i2 != 0 && topBottomOffsetForScrollingSibling >= i2 && topBottomOffsetForScrollingSibling <= i3) {
                int clamp = android.support.p002v4.math.MathUtils.clamp(i, i2, i3);
        ...
        */
        private void updateAppBarLayoutDrawableState(CoordinatorLayout coordinatorLayout, T t, int i, int i2, boolean z) {
            ...
            if (appBarChildOnOffset != null) {
                ...
                z2 = false;
                if (t.isLiftOnScroll()) {
                    if (findFirstScrollingChild.getScrollY() <= 0) {
                    }
                }
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.design.widget.AppBarLayout.BaseBehavior.SavedState.1
                ...
                public SavedState mo5639createFromParcel(Parcel parcel, ClassLoader classLoader) {
                    return new SavedState(parcel, classLoader);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: createFromParcel */
                public SavedState mo5638createFromParcel(Parcel parcel) {
                    return new SavedState(parcel, null);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: newArray */
                public SavedState[] mo5640newArray(int i) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* bridge */ /* synthetic */ View mo5641findFirstDependency(List list) {
            return mo5641findFirstDependency((List<View>) list);
        }
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0064R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0064R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout coordinatorLayout, View view, Rect rect, boolean z) {
            AppBarLayout mo5641findFirstDependency = mo5641findFirstDependency(coordinatorLayout.getDependencies(view));
            if (mo5641findFirstDependency != null) {
                rect.offset(view.getLeft(), view.getTop());
                Rect rect2 = this.tempRect1;
                rect2.set(0, 0, coordinatorLayout.getWidth(), coordinatorLayout.getHeight());
                if (!rect2.contains(rect)) {
                    mo5641findFirstDependency.setExpanded(false, !z);
                    return true;
                }
            }
            return false;
        ...
        AppBarLayout mo5641findFirstDependency(List<View> list) {
            int size = list.size();
            for (int i = 0; i < size; i++) {
