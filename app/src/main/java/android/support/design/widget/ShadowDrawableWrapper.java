...
import android.support.p005v7.graphics.drawable.DrawableWrapper;
...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    @Override // android.support.p005v7.graphics.drawable.DrawableWrapper, android.graphics.drawable.Drawable
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.shadowStartColor = ContextCompat.getColor(context, C0064R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C0064R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C0064R.color.design_fab_shadow_end_color);
