...
class MaterialCardViewHelper {
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        this.strokeColor = typedArray.getColor(C0064R.styleable.MaterialCardView_strokeColor, -1);
        this.strokeWidth = typedArray.getDimensionPixelSize(C0064R.styleable.MaterialCardView_strokeWidth, 0);
        updateForeground();
