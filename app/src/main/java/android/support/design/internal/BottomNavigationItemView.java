...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0064R.C0069layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0064R.C0066drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0064R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0064R.C0067id.icon);
        this.smallLabel = (TextView) findViewById(C0064R.C0067id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0064R.C0067id.largeLabel);
    ...
    @Override // android.view.View, android.support.p005v7.view.menu.MenuView.ItemView
