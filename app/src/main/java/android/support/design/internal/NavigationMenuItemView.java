...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0064R.C0069layout.design_navigation_menu_item, (ViewGroup) this, true);
        this.iconSize = context.getResources().getDimensionPixelSize(C0064R.dimen.design_navigation_icon_size);
        this.textView = (CheckedTextView) findViewById(C0064R.C0067id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0064R.C0067id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (getContext().getTheme().resolveAttribute(C0441R.attr.colorControlHighlight, typedValue, true)) {
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C0064R.C0066drawable.navigation_empty_icon, getContext().getTheme());
