...
import android.support.p002v4.media.MediaBrowserServiceCompatApi26;
...
import android.support.p002v4.p004os.ResultReceiver;
...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        @Override // android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        @Override // android.support.p002v4.media.MediaBrowserServiceCompatApi21.ServiceCompatProxy
        ...
        public void onLoadChildren(String str, final MediaBrowserServiceCompatApi21.ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(str, new Result<List<MediaBrowserCompat.MediaItem>>(str) { // from class: android.support.v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.2
                ...
                @Override // android.support.p002v4.media.MediaBrowserServiceCompat.Result
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        @Override // android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21, android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
        public void onCreate() {
            this.mServiceObj = MediaBrowserServiceCompatApi23.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj);
        }

        @Override // android.support.p002v4.media.MediaBrowserServiceCompatApi23.ServiceCompatProxy
    ...
    class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi26.ServiceCompatProxy {
        ...
        @Override // android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi23, android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21, android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
        public void onCreate() {
            this.mServiceObj = MediaBrowserServiceCompatApi26.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj);
        }

        @Override // android.support.p002v4.media.MediaBrowserServiceCompatApi26.ServiceCompatProxy
        ...
        @Override // android.support.p002v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21
        void notifyChildrenChangedForFramework(String str, Bundle bundle) {
            if (bundle != null) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                ...
                public void run() {
                    ...
                    if (connectionRecord.root == null) {
                        Log.i(MediaBrowserServiceCompat.TAG, "No root for client " + str + " from service " + RunnableC03281.class.getName());
                        try {
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        @Override // android.support.p002v4.media.MediaBrowserServiceCompat.ServiceCallbacks
