...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Parcelable.Creator<MediaItem> CREATOR = new Parcelable.Creator<MediaItem>() { // from class: android.support.v4.media.MediaBrowserCompat.MediaItem.1
            ...
            public MediaItem mo5697createFromParcel(Parcel parcel) {
            ...
            public MediaItem[] mo5698newArray(int i) {
    ...
    public static class ConnectionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.ConnectionCallback {
            ...
            @Override // android.support.p002v4.media.MediaBrowserCompatApi21.ConnectionCallback
            public void onConnected() {
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            @Override // android.support.p002v4.media.MediaBrowserCompatApi21.SubscriptionCallback
        ...
        private class StubApi26 extends StubApi21 implements MediaBrowserCompatApi26.SubscriptionCallback {
            ...
            @Override // android.support.p002v4.media.MediaBrowserCompatApi26.SubscriptionCallback
    ...
    public static abstract class ItemCallback {
        ...
        private class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
            ...
            @Override // android.support.p002v4.media.MediaBrowserCompatApi23.ItemCallback
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        @Override // android.support.p002v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void connect() {
            int i = this.mState;
            if (i != 0 && i != 1) {
        ...
        @Override // android.support.p002v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        @Override // android.support.p002v4.media.MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
        public void onConnectionFailed() {
        }
    ...
    static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        @Override // android.support.p002v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.p002v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            if (this.mServiceBinderWrapper == null) {
    ...
    public static class ItemReceiver extends ResultReceiver {
        ...
        @Override // android.support.p002v4.p004os.ResultReceiver
