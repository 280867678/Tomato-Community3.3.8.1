...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo5750setActionView(int i);

    @Override // android.view.MenuItem
    /* renamed from: setActionView */
    MenuItem mo5751setActionView(View view);
    ...
    SupportMenuItem mo5752setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo5753setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo5754setTooltipText(CharSequence charSequence);
}
