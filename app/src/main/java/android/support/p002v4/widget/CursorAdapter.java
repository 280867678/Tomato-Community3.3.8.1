...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(FieldType.FOREIGN_ID_FIELD_SUFFIX) : -1;
        if ((i & 2) == 2) {
    ...
    @Override // android.support.p002v4.widget.CursorFilter.CursorFilterClient
