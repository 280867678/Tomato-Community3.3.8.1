...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public static class SimplePanelSlideListener implements PanelSlideListener {
        @Override // android.support.p002v4.widget.SlidingPaneLayout.PanelSlideListener
    ...
    public void setParallaxDistance(@AbstractC0025Px int i) {
        this.mParallaxBy = i;
        requestLayout();
    }
                ...
                if (childAt2.getVisibility() != i4) {
                    ...
                    if (childAt2.getVisibility() != i4) {
                        ...
                        if (z2 && childAt2 != this.mSlideableView) {
                            if (((ViewGroup.MarginLayoutParams) layoutParams2).width < 0 && (measuredWidth2 > i11 || layoutParams2.weight > 0.0f)) {
                                if (z5) {
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v4.widget.SlidingPaneLayout.SavedState.1
            ...
            public SavedState mo5736createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo5735createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo5737newArray(int i) {
