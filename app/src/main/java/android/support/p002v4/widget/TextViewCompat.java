...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = 0) @AbstractC0025Px int i) {
        int i2;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @IntRange(from = 0) @AbstractC0025Px int i) {
        int i2;
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (Build.VERSION.SDK_INT < 16 || textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @IntRange(from = 0) @AbstractC0025Px int i) {
        Preconditions.checkArgumentNonnegative(i);
