...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i, int i2, @AbstractC0025Px int i3, @AbstractC0025Px int i4) {
        }
                    ...
                    for (int i6 = 0; i6 < pointerCount; i6++) {
                        ...
                        if (isValidPointerForActionMove(pointerId3)) {
                            ...
                            if (z2) {
                                ...
                                int i8 = (int) f2;
                                int clampViewPositionVertical = this.mCallback.clampViewPositionVertical(findTopChildUnder3, top2 + i8, i8);
                                ...
                                if (viewVerticalDragRange == 0) {
                                    break;
                                } else if (viewVerticalDragRange > 0 && clampViewPositionVertical == top2) {
                                    break;
                                }
                            }
