                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (match != -4 ? match != -3 ? match != -2 ? match != -1 ? "unknown reason" : "type" : AopConstants.APP_PROPERTIES_KEY : LogConstants.FOLLOW_OPERATION_TYPE : "category"));
                        }
                    }
