...
public class FragmentTransition {
    ...
    */
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, BackStackRecord.C0256Op c0256Op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        int i2 = z ? INVERSE_OPS[c0256Op.cmd] : c0256Op.cmd;
        boolean z7 = false;
        if (i2 != 1) {
            if (i2 != 3) {
                if (i2 == 4) {
