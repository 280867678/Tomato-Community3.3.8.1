...
import android.support.p002v4.app.Person;
...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0031R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0031R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (i3 >= 16 && i3 < 21) {
                if (z5) {
                    remoteViews.setInt(C0031R.C0033id.notification_background, "setBackgroundResource", C0031R.C0032drawable.notification_bg_low);
                    remoteViews.setInt(C0031R.C0033id.icon, "setBackgroundResource", C0031R.C0032drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0031R.C0033id.notification_background, "setBackgroundResource", C0031R.C0032drawable.notification_bg);
                    remoteViews.setInt(C0031R.C0033id.icon, "setBackgroundResource", C0031R.C0032drawable.notification_template_icon_bg);
                }
            }
            Builder builder = this.mBuilder;
            if (builder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0031R.C0033id.icon, 0);
                    remoteViews.setImageViewBitmap(C0031R.C0033id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0031R.C0033id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0031R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0031R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT >= 21) {
                        Builder builder2 = this.mBuilder;
                        remoteViews.setImageViewBitmap(C0031R.C0033id.right_icon, createIconWithBackground(builder2.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, builder2.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0031R.C0033id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0031R.C0033id.right_icon, 0);
                }
            } else if (z && builder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0031R.C0033id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    int dimensionPixelSize3 = resources.getDimensionPixelSize(C0031R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0031R.dimen.notification_big_circle_margin);
                    int dimensionPixelSize4 = resources.getDimensionPixelSize(C0031R.dimen.notification_small_icon_size_as_large);
                    Builder builder3 = this.mBuilder;
                    remoteViews.setImageViewBitmap(C0031R.C0033id.icon, createIconWithBackground(builder3.mNotification.icon, dimensionPixelSize3, dimensionPixelSize4, builder3.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0031R.C0033id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            CharSequence charSequence3 = this.mBuilder.mContentTitle;
            if (charSequence3 != null) {
                remoteViews.setTextViewText(C0031R.C0033id.title, charSequence3);
            }
            CharSequence charSequence4 = this.mBuilder.mContentText;
            if (charSequence4 != null) {
                remoteViews.setTextViewText(C0031R.C0033id.text, charSequence4);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (charSequence5 != null) {
                remoteViews.setTextViewText(C0031R.C0033id.info, charSequence5);
                remoteViews.setViewVisibility(C0031R.C0033id.info, 0);
            } else if (builder4.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0031R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0031R.C0033id.info, resources.getString(C0031R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0031R.C0033id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0031R.C0033id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0031R.C0033id.info, 8);
                charSequence = this.mBuilder.mSubText;
                if (charSequence != null && Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0031R.C0033id.text, charSequence);
                    charSequence2 = this.mBuilder.mContentText;
                    if (charSequence2 == null) {
                        remoteViews.setTextViewText(C0031R.C0033id.text2, charSequence2);
                        remoteViews.setViewVisibility(C0031R.C0033id.text2, 0);
                        z4 = true;
                        if (z4 && Build.VERSION.SDK_INT >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0031R.C0033id.text, 0, resources.getDimensionPixelSize(C0031R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0031R.C0033id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            if (this.mBuilder.mUseChronometer && Build.VERSION.SDK_INT >= 16) {
                                remoteViews.setViewVisibility(C0031R.C0033id.chronometer, 0);
                                remoteViews.setLong(C0031R.C0033id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                                remoteViews.setBoolean(C0031R.C0033id.chronometer, "setStarted", true);
                            } else {
                                remoteViews.setViewVisibility(C0031R.C0033id.time, 0);
                                remoteViews.setLong(C0031R.C0033id.time, "setTime", this.mBuilder.getWhenIfShowing());
                            }
                            z6 = true;
                        }
                        remoteViews.setViewVisibility(C0031R.C0033id.right_side, z6 ? 0 : 8);
                        int i4 = C0031R.C0033id.line3;
                        if (!z3) {
                            i2 = 8;
                        }
                    ...
                    remoteViews.setViewVisibility(C0031R.C0033id.text2, 8);
                }
                z4 = false;
                if (z4) {
                    if (z2) {
            ...
            remoteViews.setViewVisibility(C0031R.C0033id.right_side, z6 ? 0 : 8);
            int i422 = C0031R.C0033id.line3;
            if (!z3) {
            }
            remoteViews.setViewVisibility(i422, i2);
            return remoteViews;
        }
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0031R.C0032drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0031R.C0033id.notification_main_column);
            remoteViews.addView(C0031R.C0033id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0031R.C0033id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0031R.C0033id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0031R.C0033id.title, 8);
            remoteViews.setViewVisibility(C0031R.C0033id.text2, 8);
            remoteViews.setViewVisibility(C0031R.C0033id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0031R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0031R.dimen.notification_top_pad_large_text);
    ...
    public static class BigPictureStyle extends Style {
        ...
        @Override // android.support.p002v4.app.NotificationCompat.Style
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            spannableStringBuilder.append((CharSequence) ConstantUtils.PLACEHOLDER_STR_TWO).append(bidiFormatter.unicodeWrap(charSequence));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0031R.C0034layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0031R.C0033id.actions);
            if (!z || (arrayList = this.mBuilder.mActions) == null || (min = Math.min(arrayList.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0031R.C0033id.actions, generateActionButton(this.mBuilder.mActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0031R.C0033id.actions, i);
            applyStandardTemplate.setViewVisibility(C0031R.C0033id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0031R.C0034layout.notification_action_tombstone : C0031R.C0034layout.notification_action);
            remoteViews.setImageViewBitmap(C0031R.C0033id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0031R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0031R.C0033id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0031R.C0033id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0031R.C0033id.action_container, action.title);
            }
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            @Override // android.support.p002v4.app.NotificationCompat.Action.Extender
            ...
            /* renamed from: clone */
            public WearableExtender m5694clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        @Override // android.support.p002v4.app.NotificationCompat.Extender
        public Builder extend(Builder builder) {
            Bundle bundle = new Bundle();
        ...
        /* renamed from: clone */
        public WearableExtender m5695clone() {
            WearableExtender wearableExtender = new WearableExtender();
