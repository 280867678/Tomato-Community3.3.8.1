...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        @Override // android.support.p002v4.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f26id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f26id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f25id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f25id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
}
