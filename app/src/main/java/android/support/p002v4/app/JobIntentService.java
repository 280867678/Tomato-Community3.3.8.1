...
public abstract class JobIntentService extends Service {
    ...
    public static final class CompatWorkEnqueuer extends WorkEnqueuer {
        ...
        @Override // android.support.p002v4.app.JobIntentService.WorkEnqueuer
                ...
                synchronized (this) {
                    if (!this.mLaunchingService) {
                        ...
                        if (!this.mServiceProcessing) {
                            this.mLaunchWakeLock.acquire(DateUtils.ONE_MINUTE_MILLIONS);
                        }
                    }
                }
            }
    ...
    static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        final class WrapperWorkItem implements GenericWorkItem {
            ...
            @Override // android.support.p002v4.app.JobIntentService.GenericWorkItem
        ...
        @Override // android.support.p002v4.app.JobIntentService.CompatJobEngine
