...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        @Override // android.support.p002v4.content.Loader.OnLoadCompleteListener
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            loader.dump(str + ConstantUtils.PLACEHOLDER_STR_TWO, fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                LoaderObserver<D> loaderObserver = this.mObserver;
                loaderObserver.dump(str + ConstantUtils.PLACEHOLDER_STR_TWO, printWriter);
            }
            printWriter.print(str);
    ...
    @Override // android.support.p002v4.app.LoaderManager
    @NonNull
    @MainThread
