...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        if (fragmentHostCallback != null) {
            try {
                fragmentHostCallback.onDump(ConstantUtils.PLACEHOLDER_STR_TWO, null, printWriter, new String[0]);
            } catch (Exception e) {
                Log.e(TAG, "Failed dumping state", e);
            }
        } else {
            try {
                dump(ConstantUtils.PLACEHOLDER_STR_TWO, null, printWriter, new String[0]);
            } catch (Exception e2) {
    ...
    @Override // android.support.p002v4.app.FragmentManager
    ...
    */
    public void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment.mRemoving && i4 > (i5 = fragment.mState)) {
            i4 = (i5 != 0 || !fragment.isInBackStack()) ? fragment.mState : 1;
        }
        int i7 = (!fragment.mDeferStart || fragment.mState >= 3 || i4 <= 2) ? i4 : 2;
        ...
        if (i8 <= i7) {
            ...
            if (i9 != 0) {
                ...
                if (fragment3 != null) {
                    Fragment fragment4 = this.mActive.get(fragment3.mIndex);
                ...
                Fragment fragment6 = fragment.mParentFragment;
                if (fragment6 == null) {
                    this.mHost.onAttachFragment(fragment);
                } else {
                    fragment6.onAttachFragment(fragment);
                }
            ...
            if (i8 != 1) {
                ...
                if (i7 < 2) {
                    ...
                    if (view2 != null && (viewGroup = fragment.mContainer) != null) {
                        ...
                        if (loadAnimation != null) {
                            animateRemoveFragment(fragment, loadAnimation, i7);
                        }
            ...
            if (i7 < 1) {
                ...
                if (fragment.getAnimatingAway() != null || fragment.getAnimator() != null) {
                    ...
                    Log.w(TAG, "moveToState: Fragment state for " + fragment + " not updated inline; expected state " + i6 + " found " + fragment.mState);
                    fragment.mState = i6;
                    return;
                }
                if (DEBUG) {
    ...
    private void animateRemoveFragment(@NonNull final Fragment fragment, @NonNull AnimationOrAnimator animationOrAnimator, int i) {
        ...
        if (animation != null) {
            ...
            endViewTransitionAnimator.setAnimationListener(new AnimationListenerWrapper(getAnimationListener(endViewTransitionAnimator)) { // from class: android.support.v4.app.FragmentManagerImpl.2
                @Override // android.support.p002v4.app.FragmentManagerImpl.AnimationListenerWrapper, android.view.animation.Animation.AnimationListener
    ...
    */
        ...
        if (backStackStateArr != null) {
            ...
            while (true) {
                ...
                if (DEBUG) {
                    ...
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
                    instantiate2.dump(ConstantUtils.PLACEHOLDER_STR_TWO, printWriter, false);
                    printWriter.close();
                }
    ...
    public static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        @Override // android.support.p002v4.app.Fragment.OnStartEnterTransitionListener
