...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @AbstractC0025Px int i2);
    ...
    */
            ...
            if (itemInfo2 != null) {
                ...
                for (int i10 = this.mCurItem - 1; i10 >= 0; i10--) {
                    if (f < paddingLeft || i10 >= max) {
                        if (itemInfo4 != null && i10 == itemInfo4.position) {
                            ...
                            f += addNewItem(i10, i8 + 1).widthFactor;
                            i9++;
                            if (i8 >= 0) {
                                itemInfo3 = this.mItems.get(i8);
                                itemInfo4 = itemInfo3;
                ...
                if (f2 < 2.0f) {
                    ...
                    while (true) {
                        ...
                        if (i12 >= count) {
                            break;
                        } else if (f2 < paddingRight || i12 <= min) {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v4.view.ViewPager.SavedState.1
            ...
            public SavedState mo5728createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo5727createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo5729newArray(int i) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    if (i7 == 1) {
                        ...
                        left = (i5 + scrollX) - childAt.getLeft();
                        if (left != 0) {
