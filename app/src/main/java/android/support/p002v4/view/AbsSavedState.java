...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() { // from class: android.support.v4.view.AbsSavedState.2
        ...
        public AbsSavedState mo5725createFromParcel(Parcel parcel, ClassLoader classLoader) {
        ...
        /* renamed from: createFromParcel */
        public AbsSavedState mo5724createFromParcel(Parcel parcel) {
            return mo5725createFromParcel(parcel, (ClassLoader) null);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: newArray */
        public AbsSavedState[] mo5726newArray(int i) {
