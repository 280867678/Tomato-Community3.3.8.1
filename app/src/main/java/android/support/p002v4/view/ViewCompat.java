...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @AbstractC0025Px int i, @AbstractC0025Px int i2, @AbstractC0025Px int i3, @AbstractC0025Px int i4) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m5592to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0031R.C0033id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0031R.C0033id.tag_unhandled_key_listeners, map);
            }
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0031R.C0033id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0031R.C0033id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m5586at(view).preDispatch(keyEvent);
    }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m5586at(view).dispatch(view, keyEvent);
    }
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m5586at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0031R.C0033id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager == null) {
                UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
                view.setTag(C0031R.C0033id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
