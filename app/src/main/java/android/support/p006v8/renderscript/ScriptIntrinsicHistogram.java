...
/* renamed from: android.support.v8.renderscript.ScriptIntrinsicHistogram */
...
public class ScriptIntrinsicHistogram extends ScriptIntrinsic {
    ...
    public static ScriptIntrinsicHistogram create(RenderScript renderScript, Element element) {
        if (!element.isCompatible(Element.U8_4(renderScript)) && !element.isCompatible(Element.U8_3(renderScript)) && !element.isCompatible(Element.U8_2(renderScript)) && !element.isCompatible(Element.m5581U8(renderScript))) {
    ...
    public void forEach(Allocation allocation, Script.LaunchOptions launchOptions) {
        ...
        if (!allocation.getType().getElement().isCompatible(Element.m5581U8(this.mRS)) && !allocation.getType().getElement().isCompatible(Element.U8_2(this.mRS)) && !allocation.getType().getElement().isCompatible(Element.U8_3(this.mRS)) && !allocation.getType().getElement().isCompatible(Element.U8_4(this.mRS))) {
