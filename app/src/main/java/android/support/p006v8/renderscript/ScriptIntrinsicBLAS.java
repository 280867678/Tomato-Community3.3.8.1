...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void CGEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 63, i, 0, 0, 0, 0, y, x, 0, float2.f67x, float2.f68y, id, id2, float22.f67x, float22.f68y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 71, i, 0, 0, 0, 0, y, x, 0, double2.f58x, double2.f59y, id, id2, double22.f58x, double22.f59y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGBMV(int i, int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, int i4, Float2 float22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 64, i, 0, 0, 0, 0, y, x, 0, float2.f67x, float2.f68y, id, id2, float22.f67x, float22.f68y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void ZGBMV(int i, int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, int i4, Double2 double22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 72, i, 0, 0, 0, 0, y, x, 0, double2.f58x, double2.f59y, id, id2, double22.f58x, double22.f59y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void CHEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 95, 0, 0, 0, i, 0, 0, validateSYR2, 0, float2.f67x, float2.f68y, id, id2, float22.f67x, float22.f68y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHBMV(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, int i3, Float2 float22, Allocation allocation3, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 96, 0, 0, 0, i, 0, 0, validateSYR2, i2, float2.f67x, float2.f68y, id, id2, float22.f67x, float22.f68y, id3, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void CHPMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 97, 0, 0, 0, i, 0, 0, validateSPR2, 0, float2.f67x, float2.f68y, id, id2, float22.f67x, float22.f68y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGERU(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 98, 0, 0, 0, 0, 0, y, x, 0, float2.f67x, float2.f68y, id2, id3, 0.0f, 0.0f, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CGERC(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 99, 0, 0, 0, 0, 0, y, x, 0, float2.f67x, float2.f68y, id2, id3, 0.0f, 0.0f, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CHER2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 102, 0, 0, 0, i, 0, 0, validateSYR2, 0, float2.f67x, float2.f68y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHPR2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 103, 0, 0, 0, i, 0, 0, validateSPR2, 0, float2.f67x, float2.f68y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 104, 0, 0, 0, i, 0, 0, validateSYR2, 0, double2.f58x, double2.f59y, id, id2, double22.f58x, double22.f59y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHBMV(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, int i3, Double2 double22, Allocation allocation3, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 105, 0, 0, 0, i, 0, 0, validateSYR2, i2, double2.f58x, double2.f59y, id, id2, double22.f58x, double22.f59y, id3, i3, i4, 0, 0, isIncSupp);
    }
    ...
    public void ZHPMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 106, 0, 0, 0, i, 0, 0, validateSPR2, 0, double2.f58x, double2.f59y, id, id2, double22.f58x, double22.f59y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double2.f58x, double2.f59y, id2, id3, 0.0d, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double2.f58x, double2.f59y, id2, id3, 0.0d, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i, 0, 0, validateSYR2, 0, double2.f58x, double2.f59y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i, 0, 0, validateSPR2, 0, double2.f58x, double2.f59y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    static void validateL3(Element element, int i, int i2, int i3, Allocation allocation, Allocation allocation2, Allocation allocation3) {
        ...
        if ((allocation == null || allocation.getType().getElement().isCompatible(element)) && ((allocation2 == null || allocation2.getType().getElement().isCompatible(element)) && (allocation3 == null || allocation3.getType().getElement().isCompatible(element)))) {
            ...
            if (allocation != null && allocation2 != null && allocation3 != null) {
                ...
                return;
            } else if (allocation == null || allocation3 == null) {
                if (allocation != null && allocation2 != null && i4 != i8) {
                    throw new RSRuntimeException("Called BLAS with invalid dimensions");
                }
                return;
            } else if (y != x) {
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cgemm, i, i2, 0, 0, 0, i3, i5, i4, float2.f67x, float2.f68y, j, j2, float22.f67x, float22.f68y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i, i2, 0, 0, 0, i3, i5, i4, double2.f58x, double2.f59y, j, j2, double22.f58x, double22.f59y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_csymm, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float2.f67x, float2.f68y, id, id2, float22.f67x, float22.f68y, id3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 132, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double2.f58x, double2.f59y, id, id2, double22.f58x, double22.f59y, id3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_csyrk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, float2.f67x, float2.f68y, id, 0L, float22.f67x, float22.f68y, allocation2.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyrk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, double2.f58x, double2.f59y, id, 0L, double22.f58x, double22.f59y, allocation2.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYR2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 128, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, float2.f67x, float2.f68y, j, j2, float22.f67x, float22.f68y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYR2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyr2k, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, double2.f58x, double2.f59y, j, j2, double22.f58x, double22.f59y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), RsBlas_dtrmm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrmm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, float2.f67x, float2.f68y, id, j, 0.0f, 0.0f, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrmm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.f58x, double2.f59y, id, j, 0.0d, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), RsBlas_dtrsm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrsm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, float2.f67x, float2.f68y, id, j, 0.0f, 0.0f, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrsm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.f58x, double2.f59y, id, j, 0.0d, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_chemm, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float2.f67x, float2.f68y, j, j2, float22.f67x, float22.f68y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zhemm, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double2.f58x, double2.f59y, j, j2, double22.f58x, double22.f59y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHERK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cherk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, f, 0.0f, j, 0L, f2, 0.0f, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cher2k, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, float2.f67x, float2.f68y, allocation.getID(this.mRS), j, f, 0.0f, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 142, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, double2.f58x, double2.f59y, allocation.getID(this.mRS), j, d, 0.0d, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void BNNM(Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3, int i3, int i4) {
        ...
        long j2;
        long j3;
        validateL3(Element.m5581U8(this.mRS), 111, 112, 0, allocation, allocation2, allocation3);
        if (i < 0 || i > 255) {
