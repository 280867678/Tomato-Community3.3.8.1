...
import android.support.p005v7.view.ActionBarPolicy;
import android.support.p005v7.view.ActionMode;
import android.support.p005v7.view.SupportMenuInflater;
import android.support.p005v7.view.ViewPropertyAnimatorCompatSet;
...
import android.support.p005v7.widget.ActionBarContainer;
import android.support.p005v7.widget.ActionBarContextView;
import android.support.p005v7.widget.ActionBarOverlayLayout;
import android.support.p005v7.widget.DecorToolbar;
import android.support.p005v7.widget.ScrollingTabContainerView;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new ViewPropertyAnimatorUpdateListener() { // from class: android.support.v7.app.WindowDecorActionBar.3
        @Override // android.support.p002v4.view.ViewPropertyAnimatorUpdateListener
    ...
    @Override // android.support.p005v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0441R.C0444id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0441R.C0444id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0441R.C0444id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0441R.C0444id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0441R.styleable.ActionBar, C0441R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0441R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0441R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0441R.attr.actionBarWidgetTheme, typedValue, true);
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        @Override // android.support.p005v7.view.ActionMode
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // android.support.p005v7.app.ActionBar.Tab
