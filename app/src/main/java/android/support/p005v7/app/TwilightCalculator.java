...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f35C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f36C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f37C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f38J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double round = ((float) Math.round((f - f38J0) - d3)) + f38J0 + ((-d2) / 360.0d) + (Math.sin(d4) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
