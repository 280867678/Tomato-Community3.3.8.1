...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - DateUtils.ONE_DAY_MILLIONS, location.getLatitude(), location.getLongitude());
        ...
        boolean z2 = z;
        twilightCalculator.calculateTwilight(DateUtils.ONE_DAY_MILLIONS + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j5 = twilightCalculator.sunrise;
        if (j3 == -1 || j4 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j4 ? 0 + j5 : currentTimeMillis > j3 ? 0 + j4 : 0 + j3) + DateUtils.ONE_MINUTE_MILLIONS;
        }
