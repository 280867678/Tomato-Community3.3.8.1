...
import android.support.p005v7.widget.AppCompatAutoCompleteTextView;
...
import android.support.p005v7.widget.AppCompatImageButton;
import android.support.p005v7.widget.AppCompatImageView;
import android.support.p005v7.widget.AppCompatMultiAutoCompleteTextView;
import android.support.p005v7.widget.AppCompatRadioButton;
import android.support.p005v7.widget.AppCompatRatingBar;
import android.support.p005v7.widget.AppCompatSeekBar;
import android.support.p005v7.widget.AppCompatSpinner;
import android.support.p005v7.widget.AppCompatTextView;
import android.support.p005v7.widget.TintContextWrapper;
...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0441R.styleable.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C0441R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(C0441R.styleable.View_theme, 0)) != 0) {
