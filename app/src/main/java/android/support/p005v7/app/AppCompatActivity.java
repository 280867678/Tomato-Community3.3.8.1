...
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback, TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider {
    ...
    @Override // android.support.p005v7.app.AppCompatCallback
    @CallSuper
    ...
    @Override // android.support.p002v4.app.TaskStackBuilder.SupportParentable
    @Nullable
    ...
    @Override // android.support.p005v7.app.ActionBarDrawerToggle.DelegateProvider
    @Nullable
    ...
    @Override // android.support.p002v4.app.ComponentActivity, android.app.Activity, android.view.Window.Callback
