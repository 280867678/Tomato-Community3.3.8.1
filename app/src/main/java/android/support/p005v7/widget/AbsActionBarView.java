...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0441R.attr.actionBarPopupTheme, typedValue, true) && (i2 = typedValue.resourceId) != 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0441R.styleable.ActionBar, C0441R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0441R.styleable.ActionBar_height, 0));
