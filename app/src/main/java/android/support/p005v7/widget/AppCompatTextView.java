...
import android.support.p002v4.text.PrecomputedTextCompat;
...
public class AppCompatTextView extends TextView implements TintableBackgroundView, AutoSizeableTextView {
    ...
    @Override // android.widget.TextView, android.support.p002v4.widget.AutoSizeableTextView
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = 0) @AbstractC0025Px int i) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = 0) @AbstractC0025Px int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = 0) @AbstractC0025Px int i) {
