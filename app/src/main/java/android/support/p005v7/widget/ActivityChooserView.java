...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0441R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0441R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0441R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0441R.C0445layout.abc_activity_chooser_view, (ViewGroup) this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = findViewById(C0441R.C0444id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0441R.C0444id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0441R.C0444id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0441R.C0444id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0441R.C0444id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0441R.dimen.abc_config_prefDialogWidth));
    }

    @Override // android.support.p005v7.widget.ActivityChooserModel.ActivityChooserModelClient
    ...
    void showPopupUnchecked(int i) {
        ...
        if (i != Integer.MAX_VALUE) {
            ...
            if (activityCount > i + i2) {
                ...
                listPopupWindow.getListView().setContentDescription(getContext().getString(C0441R.string.abc_activitychooserview_choose_application));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0441R.C0445layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    inflate.setId(1);
                    ((TextView) inflate.findViewById(C0441R.C0444id.title)).setText(ActivityChooserView.this.getContext().getString(C0441R.string.abc_activity_chooser_view_see_all));
                    return inflate;
                }
                throw new IllegalArgumentException();
            }
            if (view == null || view.getId() != C0441R.C0444id.list_item) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0441R.C0445layout.abc_activity_chooser_view_list_item, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            ((ImageView) view.findViewById(C0441R.C0444id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(C0441R.C0444id.title)).setText(resolveInfo.loadLabel(packageManager));
