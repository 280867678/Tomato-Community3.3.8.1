...
import android.support.p002v4.graphics.drawable.WrappedDrawable;
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        if (drawable instanceof AnimationDrawable) {
            ...
            for (int i = 0; i < numberOfFrames; i++) {
                ...
                tileify.setLevel(ConstantUtils.MAX_ITEM_NUM);
                animationDrawable2.addFrame(tileify, animationDrawable.getDuration(i));
            }
            animationDrawable2.setLevel(ConstantUtils.MAX_ITEM_NUM);
