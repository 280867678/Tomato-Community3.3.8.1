...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0441R.attr.actionBarSize, 16842841};
    ...
    @Override // android.support.p005v7.widget.DecorContentParent
    ...
    */
    ...
    public LayoutParams mo5756generateDefaultLayoutParams() {
        return new LayoutParams(-1, -1);
    }

    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo5757generateLayoutParams(AttributeSet attributeSet) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0441R.C0444id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0441R.C0444id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0441R.C0444id.action_bar));
        }
    }
