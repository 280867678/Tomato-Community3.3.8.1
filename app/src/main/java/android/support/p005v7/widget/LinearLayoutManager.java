...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void updateLayoutState(int i, int i2, boolean z, RecyclerView.State state) {
        ...
        if (i == 1) {
            ...
            layoutState5.mItemDirection = i3;
            LayoutState layoutState6 = this.mLayoutState;
        ...
        if (z) {
            layoutState8.mAvailable -= startAfterPadding;
        }
    ...
    @Override // android.support.p005v7.widget.helper.ItemTouchHelper.ViewDropHandler
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: android.support.v7.widget.LinearLayoutManager.SavedState.1
            ...
            public SavedState mo5764createFromParcel(Parcel parcel) {
            ...
            public SavedState[] mo5765newArray(int i) {
