...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public abstract ShowableListMenu mo5766getPopup();
    ...
    protected boolean onForwardingStarted() {
        ShowableListMenu mo5766getPopup = mo5766getPopup();
        if (mo5766getPopup == null || mo5766getPopup.isShowing()) {
            return true;
        }
        mo5766getPopup.show();
        return true;
    ...
    */
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        View view = this.mSrc;
        ShowableListMenu mo5766getPopup = mo5766getPopup();
        if (mo5766getPopup == null || !mo5766getPopup.isShowing() || (dropDownListView = (DropDownListView) mo5766getPopup.getListView()) == null || !dropDownListView.isShown()) {
            return false;
        }
