...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private final SearchManager mSearchManager = (SearchManager) this.mContext.getSystemService(ConstantUtils.ROUTER_TYPE_SEARCH);

    @Override // android.support.p002v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.Adapter
    ...
    @Override // android.support.p002v4.widget.CursorAdapter, android.support.p002v4.widget.CursorFilter.CursorFilterClient
    ...
    @Override // android.support.p002v4.widget.ResourceCursorAdapter, android.support.p002v4.widget.CursorAdapter
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View newView = super.newView(context, cursor, viewGroup);
        newView.setTag(new ChildViewCache(newView));
        ((ImageView) newView.findViewById(C0441R.C0444id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0441R.C0444id.edit_query);
        }
    }

    @Override // android.support.p002v4.widget.CursorAdapter
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0441R.attr.textColorSearchUrl, typedValue, true);
    ...
    @Override // android.support.p002v4.widget.CursorAdapter, android.widget.Adapter
    ...
    @Override // android.support.p002v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.SpinnerAdapter
