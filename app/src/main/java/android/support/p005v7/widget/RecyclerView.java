...
import android.support.p005v7.recyclerview.C0451R;
import android.support.p005v7.widget.AdapterHelper;
import android.support.p005v7.widget.ChildHelper;
import android.support.p005v7.widget.GapWorker;
import android.support.p005v7.widget.ViewBoundsCheck;
import android.support.p005v7.widget.ViewInfoStore;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static class SimpleOnItemTouchListener implements OnItemTouchListener {
        @Override // android.support.p005v7.widget.RecyclerView.OnItemTouchListener
    ...
    public void onScrolled(@AbstractC0025Px int i, @AbstractC0025Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: android.support.v7.widget.RecyclerView.4
            @Override // android.support.p005v7.widget.ViewInfoStore.ProcessCallback
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0451R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0451R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0451R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0451R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0451R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0451R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0451R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0451R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    String exceptionLabel() {
        return ConstantUtils.PLACEHOLDER_STR_ONE + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.5
            @Override // android.support.p005v7.widget.ChildHelper.Callback
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: android.support.v7.widget.RecyclerView.6
            @Override // android.support.p005v7.widget.AdapterHelper.Callback
    ...
    @Override // android.view.View, android.support.p002v4.view.ScrollingView
    ...
    public void smoothScrollBy(@AbstractC0025Px int i, @AbstractC0025Px int i2) {
        smoothScrollBy(i, i2, null);
    }

    public void smoothScrollBy(@AbstractC0025Px int i, @AbstractC0025Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (this.mLayoutFrozen) {
    ...
    protected void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (this.mGapWorker == null) {
                ...
                gapWorker.mFrameIntervalNs = 1.0E9f / f;
    ...
    */
    ...
    private void saveFocusInfo() {
        ...
        if (this.mDataSetHasChangedAfterLayout) {
            ...
            adapterPosition = viewHolder.isRemoved() ? viewHolder.mOldPosition : viewHolder.getAdapterPosition();
        }
    ...
    */
    ...
    public void offsetChildrenVertical(@AbstractC0025Px int i) {
        int childCount = this.mChildHelper.getChildCount();
    ...
    public void offsetChildrenHorizontal(@AbstractC0025Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        @Override // android.support.p005v7.widget.RecyclerView.AdapterDataObserver
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public abstract VH mo6739onCreateViewHolder(@NonNull ViewGroup viewGroup, int i);
        ...
        public final VH createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
                ...
                VH mo6739onCreateViewHolder = mo6739onCreateViewHolder(viewGroup, i);
                if (mo6739onCreateViewHolder.itemView.getParent() != null) {
                    throw new IllegalStateException("ViewHolder views must not be attached when created. Ensure that you are not passing 'true' to the attachToRoot parameter of LayoutInflater.inflate(..., boolean attachToRoot)");
                }
                mo6739onCreateViewHolder.mItemViewType = i;
                return mo6739onCreateViewHolder;
            } finally {
                TraceCompat.endSection();
            }
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new ViewBoundsCheck.Callback() { // from class: android.support.v7.widget.RecyclerView.LayoutManager.1
            @Override // android.support.p005v7.widget.ViewBoundsCheck.Callback
            public int getChildCount() {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0451R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0451R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0451R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0451R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0451R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0451R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0451R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0451R.dimen.fastscroll_margin));
    }

    @Override // android.view.View, android.support.p002v4.view.NestedScrollingChild
    ...
    @Override // android.support.p002v4.view.NestedScrollingChild2
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(@AbstractC0025Px int i, @AbstractC0025Px int i2, @NonNull State state, @NonNull Action action);
        ...
        void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                Log.w(RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started more than once. Each instance of" + getClass().getSimpleName() + ConstantUtils.PLACEHOLDER_STR_ONE + "is intended to only be used once. You should create a new instance for each use.");
            }
            this.mRecyclerView = recyclerView;
        ...
        public static class Action {
            ...
            public Action(@AbstractC0025Px int i, @AbstractC0025Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@AbstractC0025Px int i, @AbstractC0025Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@AbstractC0025Px int i, @AbstractC0025Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@AbstractC0025Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@AbstractC0025Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@AbstractC0025Px int i, @AbstractC0025Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v7.widget.RecyclerView.SavedState.1
            ...
            public SavedState mo5768createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo5767createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo5769newArray(int i) {
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // android.support.p005v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
