...
import android.support.p005v7.widget.MenuItemHoverListener;
import android.support.p005v7.widget.MenuPopupWindow;
...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0441R.C0445layout.abc_cascading_menu_item_layout;
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: android.support.v7.view.menu.CascadingMenuPopup.3
        @Override // android.support.p005v7.widget.MenuItemHoverListener
    ...
    @Override // android.support.p005v7.view.menu.MenuPopup
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0441R.dimen.abc_config_prefDialogWidth));
    }
    ...
    @Override // android.support.p005v7.view.menu.ShowableListMenu
    public void show() {
        if (isShowing()) {
            return;
        }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        FrameLayout frameLayout = (FrameLayout) from.inflate(C0441R.C0445layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        while (true) {
            if (i2 >= count) {
                i2 = -1;
                break;
            } else if (findMenuItemForSubmenu == menuAdapter.mo5749getItem(i2)) {
                break;
            } else {
                i2++;
            }
