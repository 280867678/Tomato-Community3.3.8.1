...
import android.support.p005v7.widget.ForwardingListener;
...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0441R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0441R.styleable.ActionMenuItemView_android_minWidth, 0);
    ...
    private class ActionMenuItemForwardingListener extends ForwardingListener {
        ...
        protected boolean onForwardingStarted() {
            ShowableListMenu mo5766getPopup;
            ActionMenuItemView actionMenuItemView = ActionMenuItemView.this;
            MenuBuilder.ItemInvoker itemInvoker = actionMenuItemView.mItemInvoker;
            return itemInvoker != null && itemInvoker.invokeItem(actionMenuItemView.mItemData) && (mo5766getPopup = mo5766getPopup()) != null && mo5766getPopup.isShowing();
        }
    }
