...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    @Override // android.support.p002v4.internal.view.SupportMenuItem, android.view.MenuItem
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0441R.string.abc_prepend_shortcut_label));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i, 65536, resources.getString(C0441R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i, 4096, resources.getString(C0441R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i, 2, resources.getString(C0441R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i, 1, resources.getString(C0441R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i, 4, resources.getString(C0441R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i, 8, resources.getString(C0441R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
            sb.append(resources.getString(C0441R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(C0441R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut == ' ') {
            sb.append(resources.getString(C0441R.string.abc_menu_space_shortcut_label));
        } else {
            sb.append(shortcut);
        }
        return sb.toString();
    ...
    public SupportMenuItem mo5751setActionView(View view) {
        int i;
    ...
    @Override // android.support.p002v4.internal.view.SupportMenuItem, android.view.MenuItem
    /* renamed from: setActionView */
    public SupportMenuItem mo5750setActionView(int i) {
        Context context = this.mMenu.getContext();
        mo5751setActionView(LayoutInflater.from(context).inflate(i, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
    ...
    @Override // android.support.p002v4.internal.view.SupportMenuItem
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        if (actionProvider3 != null) {
            actionProvider3.setVisibilityListener(new ActionProvider.VisibilityListener() { // from class: android.support.v7.view.menu.MenuItemImpl.1
                @Override // android.support.p002v4.view.ActionProvider.VisibilityListener
    ...
    public SupportMenuItem mo5753setShowAsActionFlags(int i) {
        setShowAsAction(i);
        return this;
    }
    ...
    public SupportMenuItem mo5752setContentDescription(CharSequence charSequence) {
    ...
    public SupportMenuItem mo5754setTooltipText(CharSequence charSequence) {
