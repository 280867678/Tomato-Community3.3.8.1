...
import android.support.p005v7.util.ThreadUtil;
import android.support.p005v7.util.TileList;
...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes2.dex */
    class C04621 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C04621.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C04621.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C04621.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C04621.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    }
                    next = C04621.this.mQueue.next();
                }
            }
        };

        C04621(ThreadUtil.MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
        }

        @Override // android.support.p005v7.util.ThreadUtil.MainThreadCallback
    ...
    @Override // android.support.p005v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C04621(mainThreadCallback);
    }

    /* renamed from: android.support.v7.util.MessageThreadUtil$2 */
    /* loaded from: classes2.dex */
    class C04642 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C04642.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            C04642.this.mQueue.removeMessages(1);
                            C04642.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C04642.this.mQueue.removeMessages(2);
                            C04642.this.mQueue.removeMessages(3);
                            C04642.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C04642.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C04642.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
                        C04642.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C04642(ThreadUtil.BackgroundCallback backgroundCallback) {
            this.val$callback = backgroundCallback;
        }

        @Override // android.support.p005v7.util.ThreadUtil.BackgroundCallback
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C04642(backgroundCallback);
    }
