package android.support.p005v7.graphics.drawable;
...
import android.support.p005v7.graphics.drawable.DrawableContainer;
import android.support.p005v7.graphics.drawable.StateListDrawable;
...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    @Override // android.support.p005v7.graphics.drawable.StateListDrawable, android.support.p005v7.graphics.drawable.DrawableContainer, android.graphics.drawable.Drawable
    public boolean isStateful() {
        return true;
    }

    @Override // android.support.p005v7.graphics.drawable.StateListDrawable
    ...
    @Override // android.support.p005v7.graphics.drawable.DrawableContainer, android.graphics.drawable.Drawable
    @RequiresApi(21)
    ...
    @Override // android.support.p005v7.graphics.drawable.DrawableContainer, android.graphics.drawable.Drawable.Callback
    ...
    @Override // android.support.p005v7.graphics.drawable.DrawableContainer
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0441R.styleable.AnimatedStateListDrawableCompat);
        setVisible(obtainAttributes.getBoolean(C0441R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
    ...
    public static class AnimatableTransition extends Transition {
        ...
        /* renamed from: mA */
        private final Animatable f40mA;

        AnimatableTransition(Animatable animatable) {
            super();
            this.f40mA = animatable;
        }

        @Override // android.support.p005v7.graphics.drawable.AnimatedStateListDrawableCompat.Transition
        public void start() {
            this.f40mA.start();
        }
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        animatedStateListState.setVariablePadding(typedArray.getBoolean(C0441R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, animatedStateListState.mVariablePadding));
        animatedStateListState.setConstantSize(typedArray.getBoolean(C0441R.styleable.AnimatedStateListDrawableCompat_android_constantSize, animatedStateListState.mConstantSize));
        animatedStateListState.setEnterFadeDuration(typedArray.getInt(C0441R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, animatedStateListState.mEnterFadeDuration));
        animatedStateListState.setExitFadeDuration(typedArray.getInt(C0441R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, animatedStateListState.mExitFadeDuration));
        setDither(typedArray.getBoolean(C0441R.styleable.AnimatedStateListDrawableCompat_android_dither, animatedStateListState.mDither));
    }
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0441R.styleable.AnimatedStateListDrawableTransition);
        int resourceId = obtainAttributes.getResourceId(C0441R.styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
        int resourceId2 = obtainAttributes.getResourceId(C0441R.styleable.AnimatedStateListDrawableTransition_android_toId, -1);
        int resourceId3 = obtainAttributes.getResourceId(C0441R.styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
        Drawable drawable = resourceId3 > 0 ? AppCompatResources.getDrawable(context, resourceId3) : null;
        boolean z = obtainAttributes.getBoolean(C0441R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        obtainAttributes.recycle();
        if (drawable == null) {
            do {
    ...
    private int parseItem(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0441R.styleable.AnimatedStateListDrawableItem);
        int resourceId = obtainAttributes.getResourceId(C0441R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        int resourceId2 = obtainAttributes.getResourceId(C0441R.styleable.AnimatedStateListDrawableItem_android_drawable, -1);
    ...
    @Override // android.support.p005v7.graphics.drawable.StateListDrawable, android.support.p005v7.graphics.drawable.DrawableContainer
    /* renamed from: cloneConstantState */
    public AnimatedStateListState mo5742cloneConstantState() {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        @Override // android.support.p005v7.graphics.drawable.StateListDrawable.StateListState, android.support.p005v7.graphics.drawable.DrawableContainer.DrawableContainerState
        void mutate() {
            this.mTransitions = this.mTransitions.m5721clone();
            this.mStateIds = this.mStateIds.m5723clone();
        }
        ...
        @Override // android.support.p005v7.graphics.drawable.StateListDrawable.StateListState, android.graphics.drawable.Drawable.ConstantState
        @NonNull
