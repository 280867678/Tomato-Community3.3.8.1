...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0225R.C0227id.transition_transform));
        transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0225R.C0227id.parent_matrix));
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, final boolean z) {
        ...
        AnimatorListenerAdapter animatorListenerAdapter = new AnimatorListenerAdapter() { // from class: android.support.transition.ChangeTransform.3
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (z && ChangeTransform.this.mUseOverlay) {
                        ...
                        view.setTag(C0225R.C0227id.transition_transform, null);
                        view.setTag(C0225R.C0227id.parent_matrix, null);
                    }
                }
            ...
            private void setCurrentMatrix(Matrix matrix4) {
                ...
                view.setTag(C0225R.C0227id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
    ...
    private void createGhostView(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transition.mo5667addListener(new GhostListener(view, addGhost));
        if (!SUPPORTS_VIEW_REMOVAL_SUPPRESSION) {
            return;
        }
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0225R.C0227id.parent_matrix, matrix);
    ...
    public static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0225R.C0227id.transition_transform, null);
            this.mView.setTag(C0225R.C0227id.parent_matrix, null);
        }
