...
class TranslationAnimationCreator {
    ...
    public static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator) {
        ...
        int[] iArr = (int[]) transitionValues.view.getTag(C0225R.C0227id.transition_position);
        if (iArr != null) {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter {
        ...
        TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            this.mTerminalX = f;
            this.mTerminalY = f2;
            this.mTransitionPosition = (int[]) this.mViewInHierarchy.getTag(C0225R.C0227id.transition_position);
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0225R.C0227id.transition_position, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0225R.C0227id.transition_position, this.mTransitionPosition);
        }
