...
import android.support.p002v4.app.FragmentTransitionImpl;
...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    @Override // android.support.p002v4.app.FragmentTransitionImpl
    ...
    public Object cloneTransition(Object obj) {
        if (obj != null) {
            return ((Transition) obj).m5666clone();
        }
        return null;
    }
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            int size = arrayList.size();
            while (i < size) {
                transition.mo5669addTarget(arrayList.get(i));
                i++;
            }
        }
    }
    ...
    public void scheduleHideFragmentView(Object obj, final View view, final ArrayList<View> arrayList) {
        ((Transition) obj).mo5667addListener(new Transition.TransitionListener() { // from class: android.support.transition.FragmentTransitionSupport.2
    ...
    public void scheduleRemoveTargets(Object obj, final Object obj2, final ArrayList<View> arrayList, final Object obj3, final ArrayList<View> arrayList2, final Object obj4, final ArrayList<View> arrayList3) {
        ((Transition) obj).mo5667addListener(new Transition.TransitionListener() { // from class: android.support.transition.FragmentTransitionSupport.3
            @Override // android.support.transition.Transition.TransitionListener
            public void onTransitionCancel(@NonNull Transition transition) {
            }
    ...
    public void replaceTargets(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (i < size) {
                transition.mo5669addTarget(arrayList2.get(i));
                i++;
            }
            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                transition.mo5675removeTarget(arrayList.get(size2));
            }
        }
    }
    ...
    public void addTarget(Object obj, View view) {
        if (obj != null) {
            ((Transition) obj).mo5669addTarget(view);
        }
    }
    ...
    public void removeTarget(Object obj, View view) {
        if (obj != null) {
            ((Transition) obj).mo5675removeTarget(view);
        }
    }
