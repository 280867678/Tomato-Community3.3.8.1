...
public abstract class Transition implements Cloneable {
    ...
    public Transition(Context context, AttributeSet attributeSet) {
        ...
        if (namedInt >= 0) {
            mo5678setDuration(namedInt);
        }
        long namedInt2 = TypedArrayUtils.getNamedInt(obtainStyledAttributes, xmlResourceParser, "startDelay", 2, -1);
        if (namedInt2 > 0) {
            mo5681setStartDelay(namedInt2);
        }
        int namedResourceId = TypedArrayUtils.getNamedResourceId(obtainStyledAttributes, xmlResourceParser, "interpolator", 0, 0);
        if (namedResourceId > 0) {
            mo5679setInterpolator(AnimationUtils.loadInterpolator(context, namedResourceId));
        }
    ...
    public Transition mo5678setDuration(long j) {
        this.mDuration = j;
        return this;
    }
    ...
    public Transition mo5681setStartDelay(long j) {
        this.mStartDelay = j;
        return this;
    }
    ...
    public Transition mo5679setInterpolator(@Nullable TimeInterpolator timeInterpolator) {
    ...
    public Transition mo5669addTarget(@NonNull View view) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo5668addTarget(@IdRes int i) {
        if (i != 0) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo5671addTarget(@NonNull String str) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo5670addTarget(@NonNull Class cls) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo5675removeTarget(@NonNull View view) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo5674removeTarget(@IdRes int i) {
        if (i != 0) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo5677removeTarget(@NonNull String str) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo5676removeTarget(@NonNull Class cls) {
    ...
    public Transition mo5667addListener(@NonNull TransitionListener transitionListener) {
    ...
    public Transition mo5673removeListener(@NonNull TransitionListener transitionListener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo5680setSceneRoot(ViewGroup viewGroup) {
