...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    protected static final RequestOptions DOWNLOAD_ONLY_OPTIONS = new RequestOptions().mo6661diskCacheStrategy(DiskCacheStrategy.DATA).mo6697priority(Priority.LOW).mo6701skipMemoryCache(true);
    ...
    public RequestBuilder(@NonNull Glide glide, RequestManager requestManager, Class<TranscodeType> cls, Context context) {
        ...
        mo6653apply((BaseRequestOptions<?>) requestManager.getDefaultRequestOptions());
    }
    ...
    @NonNull
    /* renamed from: apply */
    public RequestBuilder<TranscodeType> mo6653apply(@NonNull BaseRequestOptions<?> baseRequestOptions) {
        Preconditions.checkNotNull(baseRequestOptions);
        return (RequestBuilder) super.mo6653apply(baseRequestOptions);
    }

    @CheckResult
    @NonNull
    /* renamed from: transition */
    public RequestBuilder<TranscodeType> mo6711transition(@NonNull TransitionOptions<?, ? super TranscodeType> transitionOptions) {
    ...
    public RequestBuilder<TranscodeType> mo6676listener(@Nullable RequestListener<TranscodeType> requestListener) {
        this.requestListeners = null;
        return mo6652addListener(requestListener);
    }

    @CheckResult
    @NonNull
    /* renamed from: addListener */
    public RequestBuilder<TranscodeType> mo6652addListener(@Nullable RequestListener<TranscodeType> requestListener) {
    ...
    @NonNull
    /* renamed from: error */
    public RequestBuilder<TranscodeType> mo6669error(@Nullable RequestBuilder<TranscodeType> requestBuilder) {
    ...
    public RequestBuilder<TranscodeType> mo6704thumbnail(@Nullable RequestBuilder<TranscodeType> requestBuilder) {
    ...
    @NonNull
    /* renamed from: thumbnail */
    public RequestBuilder<TranscodeType> mo6705thumbnail(@Nullable RequestBuilder<TranscodeType>... requestBuilderArr) {
        RequestBuilder<TranscodeType> requestBuilder = null;
        if (requestBuilderArr == null || requestBuilderArr.length == 0) {
            return mo6704thumbnail((RequestBuilder) null);
        }
        for (int length = requestBuilderArr.length - 1; length >= 0; length--) {
            RequestBuilder<TranscodeType> requestBuilder2 = requestBuilderArr[length];
            if (requestBuilder2 != null) {
                requestBuilder = requestBuilder == null ? requestBuilder2 : requestBuilder2.mo6704thumbnail(requestBuilder);
            }
        }
        return mo6704thumbnail(requestBuilder);
    }

    @CheckResult
    @NonNull
    /* renamed from: thumbnail */
    public RequestBuilder<TranscodeType> mo6703thumbnail(float f) {
        if (f < 0.0f || f > 1.0f) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6728load(@Nullable Object obj) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6723load(@Nullable Bitmap bitmap) {
        return loadGeneric(bitmap).mo6653apply((BaseRequestOptions<?>) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE));
    }
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6724load(@Nullable Drawable drawable) {
        return loadGeneric(drawable).mo6653apply((BaseRequestOptions<?>) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE));
    }
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6729load(@Nullable String str) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6725load(@Nullable Uri uri) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6726load(@Nullable File file) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6727load(@RawRes @DrawableRes @Nullable Integer num) {
        return loadGeneric(num).mo6653apply((BaseRequestOptions<?>) RequestOptions.signatureOf(ApplicationVersionSignature.obtain(this.context)));
    }
    ...
    @Deprecated
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6730load(@Nullable URL url) {
    ...
    @NonNull
    /* renamed from: load */
    public RequestBuilder<TranscodeType> mo6731load(@Nullable byte[] bArr) {
        RequestBuilder<TranscodeType> loadGeneric = loadGeneric(bArr);
        if (!loadGeneric.isDiskCacheStrategySet()) {
            loadGeneric = loadGeneric.mo6653apply((BaseRequestOptions<?>) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE));
        }
        return !loadGeneric.isSkipMemoryCacheSet() ? loadGeneric.mo6653apply((BaseRequestOptions<?>) RequestOptions.skipMemoryCacheOf(true)) : loadGeneric;
    }

    @Override // com.bumptech.glide.request.BaseRequestOptions
    @CheckResult
    /* renamed from: clone */
    public RequestBuilder<TranscodeType> mo6658clone() {
        RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.clone();
        requestBuilder.transitionOptions = (TransitionOptions<?, ? super TranscodeType>) requestBuilder.transitionOptions.m5877clone();
    ...
    public ViewTarget<ImageView, TranscodeType> into(@NonNull ImageView imageView) {
        ...
        if (!isTransformationSet() && isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (C11341.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
                    baseRequestOptions = mo6658clone().mo6687optionalCenterCrop();
                    break;
                case 2:
                    baseRequestOptions = mo6658clone().mo6688optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    baseRequestOptions = mo6658clone().mo6690optionalFitCenter();
                    break;
                case 6:
                    baseRequestOptions = mo6658clone().mo6688optionalCenterInside();
                    break;
    ...
    public <Y extends Target<File>> Y downloadOnly(@NonNull Y y) {
        return (Y) mo6675getDownloadOnlyRequest().into((RequestBuilder<File>) y);
    }

    @CheckResult
    @Deprecated
    public FutureTarget<File> downloadOnly(int i, int i2) {
        return mo6675getDownloadOnlyRequest().submit(i, i2);
    }

    @CheckResult
    @NonNull
    /* renamed from: getDownloadOnlyRequest */
    protected RequestBuilder<File> mo6675getDownloadOnlyRequest() {
        return new RequestBuilder(File.class, this).mo6653apply((BaseRequestOptions<?>) DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    private Priority getThumbnailPriority(@NonNull Priority priority) {
        int i = C11341.$SwitchMap$com$bumptech$glide$Priority[priority.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    private Request buildThumbnailRequestRecursive(Target<TranscodeType> target, RequestListener<TranscodeType> requestListener, @Nullable RequestCoordinator requestCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int i, int i2, BaseRequestOptions<?> baseRequestOptions, Executor executor) {
        ...
        if (requestBuilder != null) {
            ...
            thumbnailRequestCoordinator2.setRequests(obtainRequest(target, requestListener, baseRequestOptions, thumbnailRequestCoordinator2, transitionOptions, priority, i, i2, executor), obtainRequest(target, requestListener, baseRequestOptions.clone().mo6700sizeMultiplier(this.thumbSizeMultiplier.floatValue()), thumbnailRequestCoordinator2, transitionOptions, getThumbnailPriority(priority), i, i2, executor));
