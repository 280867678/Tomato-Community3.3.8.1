...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
        ...
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it2.hasNext()) {
                    ...
                    next.executor.execute(new CallResourceReady(next.f1213cb));
                }
    ...
    void notifyCallbacksOfException() {
        synchronized (this) {
            ...
            if (this.isCancelled) {
                ...
                while (it2.hasNext()) {
                    ResourceCallbackAndExecutor next = it2.next();
                    next.executor.execute(new CallLoadFailed(next.f1213cb));
                }
                decrementPendingCallbacks();
            }
        }
    ...
    public class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f1211cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f1211cb = resourceCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f1211cb)) {
                    EngineJob.this.callCallbackOnLoadFailed(this.f1211cb);
                }
    ...
    public class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f1212cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f1212cb = resourceCallback;
        }

        @Override // java.lang.Runnable
        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f1212cb)) {
                    EngineJob.this.engineResource.acquire();
                    EngineJob.this.callCallbackOnResourceReady(this.f1212cb);
                    EngineJob.this.removeCallback(this.f1212cb);
                }
                EngineJob.this.decrementPendingCallbacks();
            }
        }
    ...
    public static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f1213cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor) {
            this.f1213cb = resourceCallback;
            this.executor = executor;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f1213cb.equals(((ResourceCallbackAndExecutor) obj).f1213cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f1213cb.hashCode();
        }
    }
