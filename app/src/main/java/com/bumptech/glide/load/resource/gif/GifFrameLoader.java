...
public class GifFrameLoader {
    ...
    private void loadNextFrame() {
        ...
        this.requestBuilder.mo6653apply((BaseRequestOptions<?>) RequestOptions.signatureOf(getFrameSignature())).mo6728load((Object) this.gifDecoder).into((RequestBuilder<Bitmap>) this.next);
    }
