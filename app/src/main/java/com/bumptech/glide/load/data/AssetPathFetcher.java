...
public abstract class AssetPathFetcher<T> implements DataFetcher<T> {
    ...
    protected abstract T mo5883loadResource(AssetManager assetManager, String str) throws IOException;
    ...
    public void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super T> dataCallback) {
        try {
            this.data = mo5883loadResource(this.assetManager, this.assetPath);
