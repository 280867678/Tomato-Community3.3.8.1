...
public abstract class LocalUriFetcher<T> implements DataFetcher<T> {
    ...
    protected abstract T mo5884loadResource(Uri uri, ContentResolver contentResolver) throws FileNotFoundException;
    ...
    public final void loadData(@NonNull Priority priority, @NonNull DataFetcher.DataCallback<? super T> dataCallback) {
        try {
            this.data = mo5884loadResource(this.uri, this.contentResolver);
