...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1201ix = readShort();
        this.header.currentFrame.f1202iy = readShort();
        this.header.currentFrame.f1200iw = readShort();
        this.header.currentFrame.f1199ih = readShort();
        int read = read();
        boolean z = false;
