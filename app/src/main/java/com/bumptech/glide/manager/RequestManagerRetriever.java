...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    @VisibleForTesting
    final Map<android.support.p002v4.app.FragmentManager, SupportRequestManagerFragment> pendingSupportRequestManagerFragments = new HashMap();
    ...
    @NonNull
    private SupportRequestManagerFragment getSupportRequestManagerFragment(@NonNull android.support.p002v4.app.FragmentManager fragmentManager, @Nullable Fragment fragment, boolean z) {
    ...
    @NonNull
    private RequestManager supportFragmentGet(@NonNull Context context, @NonNull android.support.p002v4.app.FragmentManager fragmentManager, @Nullable Fragment fragment, boolean z) {
    ...
    public boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            ...
            obj = (android.support.p002v4.app.FragmentManager) message.obj;
