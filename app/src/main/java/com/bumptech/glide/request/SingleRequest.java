...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback, FactoryPools.Poolable {
    ...
    private static final Pools.Pool<SingleRequest<?>> POOL = FactoryPools.threadSafe(150, new FactoryPools.Factory<SingleRequest<?>>() { // from class: com.bumptech.glide.request.SingleRequest.1
        ...
        /* renamed from: create */
        public SingleRequest<?> mo5904create() {
    ...
    public synchronized void onResourceReady(Resource<?> resource, DataSource dataSource) {
        ...
        Object mo5902get = resource.mo5902get();
        if (mo5902get != null && this.transcodeClass.isAssignableFrom(mo5902get.getClass())) {
            if (!canSetResource()) {
                releaseResource(resource);
                this.status = Status.COMPLETE;
                return;
            }
            onResourceReady(resource, mo5902get, dataSource);
            return;
        }
        releaseResource(resource);
        ...
        sb.append(mo5902get != null ? mo5902get.getClass() : "");
        sb.append("{");
        sb.append(mo5902get);
        sb.append("} inside Resource{");
        sb.append(resource);
        sb.append("}.");
        sb.append(mo5902get != null ? "" : " To indicate failure return a null Resource object, rather than a Resource object containing null data.");
