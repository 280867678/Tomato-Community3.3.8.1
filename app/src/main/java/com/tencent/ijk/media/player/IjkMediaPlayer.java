...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m3494w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m3494w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
            ...
            if (ijkMediaPlayer != null) {
                ...
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i == 1) {
                        ...
                        DebugLog.m3500e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                        ...
                        if (message.arg1 == 3) {
                            DebugLog.m3498i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                        }
                        ...
                        switch (i) {
                            ...
                            case IjkMediaPlayer.MEDIA_VIDEO_DECODER_ERROR /* 212 */:
                                ...
                                return;
                            default:
                                DebugLog.m3500e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                                return;
                        }
                    }
                }
            }
            DebugLog.m3494w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
