...
public class IjkMediaFormat implements IMediaFormat {
    ...
    public IjkMediaFormat(IjkMediaMeta.IjkStreamMeta ijkStreamMeta) {
        sFormatterMap.put("ijk-codec-long-name-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.1
        ...
        sFormatterMap.put("ijk-codec-name-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.2
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
                return IjkMediaFormat.this.mMediaFormat.getString("codec_name");
            }
        });
        sFormatterMap.put("ijk-bit-rate-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.3
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
        ...
        sFormatterMap.put("ijk-profile-level-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.4
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            protected String doFormat(IjkMediaFormat ijkMediaFormat) {
                String str;
        ...
        sFormatterMap.put("ijk-pixel-format-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.5
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            protected String doFormat(IjkMediaFormat ijkMediaFormat) {
                return ijkMediaFormat.getString("codec_pixel_format");
            }
        });
        sFormatterMap.put("ijk-resolution-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.6
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            protected String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        sFormatterMap.put("ijk-frame-rate-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.7
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            protected String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        sFormatterMap.put("ijk-sample-rate-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.8
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            protected String doFormat(IjkMediaFormat ijkMediaFormat) {
        ...
        sFormatterMap.put("ijk-channel-ui", new Formatter() { // from class: com.tencent.ijk.media.player.misc.IjkMediaFormat.9
            @Override // com.tencent.ijk.media.player.misc.IjkMediaFormat.Formatter
            protected String doFormat(IjkMediaFormat ijkMediaFormat) {
