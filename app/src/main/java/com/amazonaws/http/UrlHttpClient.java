...
public class UrlHttpClient implements HttpClient {
    ...
    /* renamed from: sc */
    private SSLContext f1170sc = null;
    ...
    private void enableCustomTrustManager(HttpsURLConnection httpsURLConnection) {
        if (this.f1170sc == null) {
            TrustManager[] trustManagerArr = {this.config.getTrustManager()};
            try {
                this.f1170sc = SSLContext.getInstance("TLS");
                this.f1170sc.init(null, trustManagerArr, null);
            } catch (GeneralSecurityException e) {
                throw new RuntimeException(e);
            }
        }
        httpsURLConnection.setSSLSocketFactory(this.f1170sc.getSocketFactory());
    }
