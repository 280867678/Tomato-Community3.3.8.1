...
/* renamed from: com.pm.liquidlink.activity.LiquidLinkFragmentActivity */
/* loaded from: classes3.dex */
public abstract class LiquidLinkFragmentActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.liquidlinkWakeUpAdapter = new AppWakeUpAdapter() { // from class: com.pm.liquidlink.activity.LiquidLinkFragmentActivity.1
            @Override // com.p089pm.liquidlink.listener.AppWakeUpAdapter
            public void onWakeUp(AppData appData) {
                LiquidLinkFragmentActivity.this.wakeup(appData);
            }
        };
