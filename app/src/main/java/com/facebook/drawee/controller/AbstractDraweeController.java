...
public abstract class AbstractDraweeController<T, INFO> implements DraweeController, DeferredReleaser.Releasable, GestureDetector.ClickListener {
    ...
    protected T mo5929getCachedImage() {
        return null;
    }
    ...
    private synchronized void init(String str, Object obj) {
        ...
        if (FLog.isLoggable(2)) {
            FLog.m4146v(TAG, "controller %x %s -> %s: initialize", Integer.valueOf(System.identityHashCode(this)), this.mId, str);
        }
        this.mId = str;
    ...
    public void setHierarchy(DraweeHierarchy draweeHierarchy) {
        if (FLog.isLoggable(2)) {
            FLog.m4146v(TAG, "controller %x %s: setHierarchy: %s", Integer.valueOf(System.identityHashCode(this)), this.mId, draweeHierarchy);
        }
    ...
    public void onAttach() {
        ...
        if (FLog.isLoggable(2)) {
            FLog.m4146v(TAG, "controller %x %s: onAttach: %s", Integer.valueOf(System.identityHashCode(this)), this.mId, this.mIsRequestSubmitted ? "request already submitted" : "request needs submit");
        }
    ...
    public void onDetach() {
        ...
        if (FLog.isLoggable(2)) {
            FLog.m4147v(TAG, "controller %x %s: onDetach", Integer.valueOf(System.identityHashCode(this)), this.mId);
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (FLog.isLoggable(2)) {
            FLog.m4146v(TAG, "controller %x %s: onTouchEvent %s", Integer.valueOf(System.identityHashCode(this)), this.mId, motionEvent);
        }
        GestureDetector gestureDetector = this.mGestureDetector;
        if (gestureDetector == null) {
            return false;
    ...
    public boolean onClick() {
        if (FLog.isLoggable(2)) {
            FLog.m4147v(TAG, "controller %x %s: onClick", Integer.valueOf(System.identityHashCode(this)), this.mId);
        }
        if (shouldRetryOnTap()) {
    ...
    protected void submitRequest() {
        ...
        T mo5929getCachedImage = mo5929getCachedImage();
        if (mo5929getCachedImage != null) {
            if (FrescoSystrace.isTracing()) {
            ...
            onImageLoadedFromCacheImmediately(this.mId, mo5929getCachedImage);
            onNewResultInternal(this.mId, this.mDataSource, mo5929getCachedImage, 1.0f, true, true, true);
            if (FrescoSystrace.isTracing()) {
                FrescoSystrace.endSection();
            }
            if (!FrescoSystrace.isTracing()) {
        ...
        if (FLog.isLoggable(2)) {
            FLog.m4146v(TAG, "controller %x %s: submitRequest: dataSource: %x", Integer.valueOf(System.identityHashCode(this)), this.mId, Integer.valueOf(System.identityHashCode(this.mDataSource)));
        }
        ...
        this.mDataSource.subscribe(new BaseDataSubscriber<T>() { // from class: com.facebook.drawee.controller.AbstractDraweeController.1
            ...
            public void onNewResultImpl(DataSource<T> dataSource) {
                ...
                T mo5940getResult = dataSource.mo5940getResult();
                if (mo5940getResult != null) {
                    AbstractDraweeController.this.onNewResultInternal(str, dataSource, mo5940getResult, progress, isFinished, hasResult, hasMultipleResults);
                } else if (!isFinished) {
                } else {
    ...
    private void logMessageAndImage(String str, T t) {
        if (FLog.isLoggable(2)) {
            FLog.m4144v(TAG, "controller %x %s: %s: image: %s %x", Integer.valueOf(System.identityHashCode(this)), this.mId, str, getImageClass(t), Integer.valueOf(getImageHash(t)));
        }
    }

    private void logMessageAndFailure(String str, Throwable th) {
        if (FLog.isLoggable(2)) {
            FLog.m4145v(TAG, "controller %x %s: %s: failure: %s", Integer.valueOf(System.identityHashCode(this)), this.mId, str, th);
        }
    }
