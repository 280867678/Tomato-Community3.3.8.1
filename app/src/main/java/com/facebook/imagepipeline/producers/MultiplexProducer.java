...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    /* renamed from: getKey */
    protected abstract K mo5957getKey(ProducerContext producerContext);
    ...
    public void produceResults(Consumer<T> consumer, ProducerContext producerContext) {
        ...
        try {
            ...
            K mo5957getKey = mo5957getKey(producerContext);
            do {
                z = false;
                synchronized (this) {
                    existingMultiplexer = getExistingMultiplexer(mo5957getKey);
                    if (existingMultiplexer == null) {
                        existingMultiplexer = createAndPutNewMultiplexer(mo5957getKey);
                        z = true;
                    }
                }
