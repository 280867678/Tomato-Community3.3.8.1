...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    @Override // android.graphics.drawable.Drawable
    public void setAlpha(@IntRange(from = 0, m5591to = 255) int i) {
        this.alpha = i;
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        float f;
        C0839L.beginSection("Drawable#draw");
        ...
        C0839L.endSection("Drawable#draw");
        if (i <= 0) {
            return;
        }
        canvas.restore();
    ...
    public void setMaxProgress(@FloatRange(from = 0.0d, m5592to = 1.0d) final float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
    ...
    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, m5592to = 1.0d) final float f, @FloatRange(from = 0.0d, m5592to = 1.0d) final float f2) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
    ...
    public void setProgress(@FloatRange(from = 0.0d, m5592to = 1.0d) final float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
