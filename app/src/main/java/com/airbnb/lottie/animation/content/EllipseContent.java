...
public class EllipseContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public EllipseContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, CircleShape circleShape) {
        ...
        this.sizeAnimation = circleShape.getSize().mo5808createAnimation();
        this.positionAnimation = circleShape.getPosition().mo5808createAnimation();
    ...
    public Path getPath() {
        ...
        this.path.offset(mo5805getValue2.x, mo5805getValue2.y);
        this.path.close();
