...
public class SplitDimensionPathKeyframeAnimation extends BaseKeyframeAnimation<PointF, PointF> {
    ...
    public void setProgress(float f) {
        ...
        this.point.set(this.xAnimation.mo5805getValue().floatValue(), this.yAnimation.mo5805getValue().floatValue());
    ...
    public PointF mo5805getValue() {
        return mo5807getValue((Keyframe<PointF>) null, 0.0f);
    }
