...
public class TrimPathContent implements Content, BaseKeyframeAnimation.AnimationListener {
    ...
    public TrimPathContent(BaseLayer baseLayer, ShapeTrimPath shapeTrimPath) {
        ...
        this.startAnimation = shapeTrimPath.getStart().mo5808createAnimation();
        this.endAnimation = shapeTrimPath.getEnd().mo5808createAnimation();
        this.offsetAnimation = shapeTrimPath.getOffset().mo5808createAnimation();
