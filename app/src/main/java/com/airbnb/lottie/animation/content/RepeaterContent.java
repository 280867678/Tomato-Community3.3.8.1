...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public RepeaterContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, Repeater repeater) {
        ...
        this.copies = repeater.getCopies().mo5808createAnimation();
        baseLayer.addAnimation(this.copies);
        this.copies.addUpdateListener(this);
        this.offset = repeater.getOffset().mo5808createAnimation();
    ...
    public Path getPath() {
        ...
        this.path.reset();
        float floatValue = this.copies.mo5805getValue().floatValue();
        float floatValue2 = this.offset.mo5805getValue().floatValue();
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        float floatValue = this.copies.mo5805getValue().floatValue();
        float floatValue2 = this.offset.mo5805getValue().floatValue();
        float floatValue3 = this.transform.getStartOpacity().mo5805getValue().floatValue() / 100.0f;
        float floatValue4 = this.transform.getEndOpacity().mo5805getValue().floatValue() / 100.0f;
