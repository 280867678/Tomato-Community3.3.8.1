    ...
    public Object applyMethodWithArguments(View view, Object[] objArr) {
        if (this.mTargetClass.isAssignableFrom(view.getClass())) {
            try {
                ...
                SALog.m3673i(TAG, "Method " + this.mTargetMethod.getName() + " appears not to be public", e);
                return null;
            } catch (IllegalArgumentException e2) {
                SALog.m3673i(TAG, "Method " + this.mTargetMethod.getName() + " called with arguments of the wrong type", e2);
                return null;
            } catch (InvocationTargetException e3) {
                SALog.m3673i(TAG, "Method " + this.mTargetMethod.getName() + " threw an exception", e3);
                return null;
            }
        }
        return null;
