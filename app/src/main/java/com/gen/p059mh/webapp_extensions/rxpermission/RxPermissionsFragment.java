...
/* renamed from: com.gen.mh.webapp_extensions.rxpermission.RxPermissionsFragment */
    ...
    public void onRequestPermissionsResult(String[] strArr, int[] iArr, boolean[] zArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (publishSubject == null) {
                Logger.m4112i("RxPermissions", "RxPermissions.onRequestPermissionsResult invoked but didn't find the corresponding permission request.");
                return;
            }
