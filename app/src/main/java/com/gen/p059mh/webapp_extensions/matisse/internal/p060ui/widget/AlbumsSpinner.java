...
/* renamed from: com.gen.mh.webapp_extensions.matisse.internal.ui.widget.AlbumsSpinner */
...
public class AlbumsSpinner {
    ...
    public AlbumsSpinner(@NonNull Context context) {
        ...
        this.mListPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.gen.mh.webapp_extensions.matisse.internal.ui.widget.AlbumsSpinner.1
    ...
    public void setSelectedTextView(TextView textView) {
        ...
        TypedArray obtainStyledAttributes = this.mSelected.getContext().getTheme().obtainStyledAttributes(new int[]{R$attr.sdk_album_element_color});
        int color = obtainStyledAttributes.getColor(0, 0);
        obtainStyledAttributes.recycle();
        drawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        this.mSelected.setVisibility(8);
        this.mSelected.setOnClickListener(new View.OnClickListener() { // from class: com.gen.mh.webapp_extensions.matisse.internal.ui.widget.AlbumsSpinner.2
