...
public final class C0921a {
    /* renamed from: a */
    public static boolean m4778a(Context context) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(C0934h.m4726e(context));
        return m4777a(arrayList) || m4777a(new ArrayList<String>() { // from class: com.alipay.apmobilesecuritysdk.common.RushTimeUtil$1
    ...
    /* renamed from: a */
    private static boolean m4777a(List<String> list) {
