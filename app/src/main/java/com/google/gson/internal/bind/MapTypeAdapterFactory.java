...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo6312read(JsonReader jsonReader) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K mo6312read = this.keyTypeAdapter.mo6312read(jsonReader);
                    if (construct.put(mo6312read, this.valueTypeAdapter.mo6312read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo6312read);
                    }
                    jsonReader.endArray();
                }
                jsonReader.endArray();
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo6312read2 = this.keyTypeAdapter.mo6312read(jsonReader);
                    if (construct.put(mo6312read2, this.valueTypeAdapter.mo6312read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo6312read2);
                    }
                }
