...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    public byte[] getRow(int i, byte[] bArr) {
        ...
        System.arraycopy(this.yuvData, ((i + this.f6100top) * this.dataWidth) + this.left, bArr, 0, width);
        return bArr;
    }
    ...
    public int[] renderThumbnail() {
        ...
        int i = (this.f6100top * this.dataWidth) + this.left;
    ...
    private void reverseHorizontal(int i, int i2) {
        byte[] bArr = this.yuvData;
        int i3 = (this.f6100top * this.dataWidth) + this.left;
        int i4 = 0;
        while (i4 < i2) {
            int i5 = (i / 2) + i3;
            int i6 = (i3 + i) - 1;
