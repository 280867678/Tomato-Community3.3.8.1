...
final class DecodedBitStreamParser {
    ...
    public static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                int i = C20711.f1333xb73eb560[mode.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C20711 {
        ...
        static final /* synthetic */ int[] f1333xb73eb560 = new int[Mode.values().length];

        static {
            try {
                f1333xb73eb560[Mode.C40_ENCODE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1333xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1333xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1333xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1333xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
