...
public final class HighLevelEncoder {
    ...
    */
    public BitArray encode() {
        int i;
        Collection<State> updateStateListForChar;
            ...
            if (i2 < bArr.length) {
                ...
                if (b2 == 13) {
                    if (b == 10) {
                        ...
                        i2++;
                        singletonList = updateStateListForChar;
                    }
                    i = 0;
                    if (i <= 0) {
                    }
                    ...
                    if (b2 == 58 && b == 32) {
                        i = 5;
                        if (i <= 0) {
                            updateStateListForChar = updateStateListForPair(singletonList, i2, i);
                            i2 = i3;
                        } else {
                            updateStateListForChar = updateStateListForChar(singletonList, i2);
                        }
                        i2++;
                        singletonList = updateStateListForChar;
                    }
