...
public final class WebvttCueParser {
        ...
        while (i < str2.length()) {
            ...
            if (charAt == '&') {
                ...
                if (indexOf != -1) {
                    ...
                    if (indexOf == indexOf2) {
                        spannableStringBuilder.append(ConstantUtils.PLACEHOLDER_STR_ONE);
                    }
                    i = indexOf + 1;
                } else {
    ...
    private static int parsePositionAnchor(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case 100571:
                ...
                break;
            case 109757538:
                if (str.equals(C2516Ad.TYPE_START)) {
                    c = 0;
                    break;
                }
                c = 65535;
    ...
    private static boolean isSupportedTag(String str) {
        ...
        int hashCode = str.hashCode();
        if (hashCode == 98) {
            if (str.equals(EGL10Helper.f2537a)) {
                c = 0;
            }
            c = 65535;
        } else if (hashCode == 99) {
    ...
    private static void applySpansForTag(String str, StartTag startTag, SpannableStringBuilder spannableStringBuilder, List<WebvttCssStyle> list, List<StyleMatch> list2) {
        ...
        if (hashCode == 0) {
            ...
            if (str2.equals(EGL10Helper.f2537a)) {
                c = 0;
            }
            c = 65535;
        } else if (hashCode == 99) {
    ...
    public static final class StartTag {
        ...
        public static StartTag buildStartTag(String str, int i) {
            ...
            int indexOf = trim.indexOf(ConstantUtils.PLACEHOLDER_STR_ONE);
            if (indexOf == -1) {
                str2 = "";
            } else {
