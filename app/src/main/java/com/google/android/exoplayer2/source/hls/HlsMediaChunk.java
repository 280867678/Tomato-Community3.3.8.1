...
public final class HlsMediaChunk extends MediaChunk {
    ...
    /* JADX WARN: Removed duplicated region for block: B:16:0x0061 A[Catch: all -> 0x00a2, TryCatch #1 {all -> 0x00a2, blocks: (B:10:0x0038, B:12:0x004c, B:14:0x0050, B:16:0x0061, B:17:0x006a, B:18:0x0068, B:20:0x006f, B:27:0x0090, B:23:0x0076, B:25:0x007a), top: B:9:0x0038 }] */
    /* JADX WARN: Removed duplicated region for block: B:18:0x0068 A[Catch: all -> 0x00a2, TryCatch #1 {all -> 0x00a2, blocks: (B:10:0x0038, B:12:0x004c, B:14:0x0050, B:16:0x0061, B:17:0x006a, B:18:0x0068, B:20:0x006f, B:27:0x0090, B:23:0x0076, B:25:0x007a), top: B:9:0x0038 }] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x006f A[Catch: all -> 0x00a2, TRY_LEAVE, TryCatch #1 {all -> 0x00a2, blocks: (B:10:0x0038, B:12:0x004c, B:14:0x0050, B:16:0x0061, B:17:0x006a, B:18:0x0068, B:20:0x006f, B:27:0x0090, B:23:0x0076, B:25:0x007a), top: B:9:0x0038 }] */
    ...
    private void loadMedia() throws IOException, InterruptedException {
        ...
        try {
            ...
            if (this.isPackedAudioExtractor) {
                ...
                this.id3TimestampPeeked = true;
                this.output.setSampleOffsetUs(peekId3PrivTimestamp2 == -9223372036854775807L ? this.timestampAdjuster.adjustTsTimestamp(peekId3PrivTimestamp2) : this.startTimeUs);
            }
            if (z) {
            }
            while (i == 0) {
