...
public final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, Loader.ReleaseCallback, SequenceableLoader, ExtractorOutput, SampleQueue.UpstreamFormatChangedListener {
    ...
    */
        ...
        if (this.enabledTrackGroupCount == 0) {
            ...
            if (!this.mediaChunks.isEmpty() && !Util.areEqual(trackSelection2, trackSelection)) {
                if (!this.seenFirstTrackSelection) {
                    ...
                    trackSelection2.updateSelectedTrack(j, j2, -9223372036854775807L);
    ...
    private static Format deriveFormat(Format format, Format format2, boolean z) {
        ...
        return format2.copyWithContainerInfo(format.f1312id, mediaMimeType, codecsOfType, i, format.width, format.height, format.selectionFlags, format.language);
    }
