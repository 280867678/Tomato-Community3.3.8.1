...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    protected void parsePayload(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            this.output.format(Format.createVideoSampleFormat(null, MediaController.MIME_TYPE, null, -1, -1, parse.width, parse.height, -1.0f, parse.initializationData, -1, parse.pixelWidthAspectRatio, null));
