...
public abstract class CeaDecoder implements SubtitleDecoder {
    ...
    public SubtitleInputBuffer mo6242dequeueInputBuffer() throws SubtitleDecoderException {
    ...
    public SubtitleOutputBuffer mo6243dequeueOutputBuffer() throws SubtitleDecoderException {
