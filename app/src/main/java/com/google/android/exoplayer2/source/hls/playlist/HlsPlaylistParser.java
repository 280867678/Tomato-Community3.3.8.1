...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    /* renamed from: parse */
    public HlsPlaylist mo6240parse(Uri uri, InputStream inputStream) throws IOException {
        String trim;
    ...
    private static HlsMasterPlaylist parseMasterPlaylist(LineIterator lineIterator, String str) throws IOException {
        ...
        while (lineIterator.hasNext()) {
            ...
            if (next.startsWith("#EXT-X-MEDIA")) {
                ...
                if (hashSet.add(next2)) {
                    arrayList.add(new HlsMasterPlaylist.HlsUrl(next2, Format.createVideoContainerFormat(Integer.toString(arrayList.size()), "application/x-mpegURL", null, parseOptionalStringAttr2, i4, i, i2, parseFloat, null, 0)));
                }
            }
        }
        int i5 = 0;
        ...
        while (i5 < arrayList4.size()) {
            ...
            if (c == 0) {
                ...
                Format createAudioContainerFormat = Format.createAudioContainerFormat(parseStringAttr, "application/x-mpegURL", str4 != null ? MimeTypes.getMediaMimeType(str4) : null, str4, -1, -1, -1, null, parseSelectionFlags, parseOptionalStringAttr7);
            ...
            if (next.startsWith("#EXT-X-PLAYLIST-TYPE")) {
                ...
                if (!"NONE".equals(parseOptionalStringAttr2)) {
                    ...
                    if ("identity".equals(parseOptionalStringAttr3) || parseOptionalStringAttr3 == null) {
                        ...
                        drmInitData = new DrmInitData(("SAMPLE-AES-CENC".equals(parseOptionalStringAttr2) || "SAMPLE-AES-CTR".equals(parseOptionalStringAttr2)) ? "cenc" : "cbcs", parseWidevineSchemeData);
                    }
                    str3 = parseOptionalStringAttr4;
                    str2 = null;
                } else {
                ...
                if (j3 == 0) {
                    j3 = C1868C.msToUs(Util.parseXsDateTime(next.substring(next.indexOf(58) + 1))) - j8;
                }
    ...
    private static DrmInitData.SchemeData parseWidevineSchemeData(String str, String str2) throws ParserException {
        if ("urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2)) {
            ...
            return new DrmInitData.SchemeData(C1868C.WIDEVINE_UUID, "video/mp4", Base64.decode(parseStringAttr.substring(parseStringAttr.indexOf(44)), 0));
        } else if (!"com.widevine".equals(str2)) {
            return null;
        } else {
            try {
                return new DrmInitData.SchemeData(C1868C.WIDEVINE_UUID, "hls", str.getBytes("UTF-8"));
