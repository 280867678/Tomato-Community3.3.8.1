    ...
    */
    public Timeline.Window getWindow(int i, Timeline.Window window, boolean z, long j) {
        ...
        if (this.isDynamic && j != 0) {
            ...
            window.set(obj, this.presentationStartTimeMs, this.windowStartTimeMs, this.isSeekable, this.isDynamic, j2, this.windowDurationUs, 0, 0, this.windowPositionInPeriodUs);
            return window;
        }
        j2 = j3;
        window.set(obj, this.presentationStartTimeMs, this.windowStartTimeMs, this.isSeekable, this.isDynamic, j2, this.windowDurationUs, 0, 0, this.windowPositionInPeriodUs);
