            ...
            case 17:
                ...
                if (readBits2 == subtitleService.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0) {
                        parseRegionComposition.mergeFrom(subtitleService.regions.get(parseRegionComposition.f1325id));
                    }
                    subtitleService.regions.put(parseRegionComposition.f1325id, parseRegionComposition);
                    break;
                }
                break;
            case 18:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(parseClutDefinition.f1323id, parseClutDefinition);
                    break;
                    ...
                    subtitleService.ancillaryCluts.put(parseClutDefinition2.f1323id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(parseObjectData.f1324id, parseObjectData);
                    break;
                } else if (readBits2 == subtitleService.ancillaryPageId) {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(parseObjectData2.f1324id, parseObjectData2);
                    break;
                }
                break;
            case 20:
