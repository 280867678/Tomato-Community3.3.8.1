...
public final class Id3Decoder implements MetadataDecoder {
    ...
    static {
        new FramePredicate() { // from class: com.google.android.exoplayer2.metadata.id3.Id3Decoder.1
    ...
    */
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        return new ApicFrame(str, new String(bArr, i4, indexOfEos - i4, charsetName), bArr[indexOfZeroByte + 1] & 255, copyOfRangeIfValid(bArr, indexOfEos + delimiterLength(readUnsignedByte), bArr.length));
    }
