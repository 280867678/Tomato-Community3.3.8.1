...
public class DefaultDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T>, DefaultDrmSession.ProvisioningManager<T> {
    ...
    public boolean canAcquireSession(@NonNull DrmInitData drmInitData) {
        ...
        if (getSchemeData(drmInitData, this.uuid, true) == null) {
            if (drmInitData.schemeDataCount != 1 || !drmInitData.get(0).matches(C1868C.COMMON_PSSH_UUID)) {
                return false;
            }
    ...
    public DrmSession<T> acquireSession(Looper looper, DrmInitData drmInitData) {
        ...
        if (this.offlineLicenseKeySetId == null) {
            ...
            if (schemeData2 == null) {
                this.eventDispatcher.drmSessionManagerError(new MissingSchemeDataException(this.uuid));
                throw null;
            }
    ...
    public void onProvisionError(Exception exc) {
        Iterator<DefaultDrmSession<T>> it2 = this.provisioningSessions.iterator();
        if (it2.hasNext()) {
    ...
    private static DrmInitData.SchemeData getSchemeData(DrmInitData drmInitData, UUID uuid, boolean z) {
        ...
        while (true) {
            ...
            if (!schemeData.matches(uuid) && (!C1868C.CLEARKEY_UUID.equals(uuid) || !schemeData.matches(C1868C.COMMON_PSSH_UUID))) {
                z2 = false;
            }
        ...
        if (C1868C.WIDEVINE_UUID.equals(uuid)) {
