...
final class ResamplingAudioProcessor implements AudioProcessor {
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x0081 A[LOOP:2: B:24:0x0081->B:25:0x0083, LOOP_START, PHI: r0 
      PHI: (r0v1 int) = (r0v0 int), (r0v2 int) binds: [B:10:0x0041, B:25:0x0083] A[DONT_GENERATE, DONT_INLINE]] */
