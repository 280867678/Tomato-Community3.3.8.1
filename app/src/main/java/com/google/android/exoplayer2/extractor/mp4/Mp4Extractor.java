...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private ArrayList<TrackSampleTable> getTrackSampleTables(Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder, boolean z) throws ParserException {
        ...
        for (int i = 0; i < containerAtom.containerChildren.size(); i++) {
            ...
            if (containerAtom2.type == Atom.TYPE_trak && (parseTrak = AtomParsers.parseTrak(containerAtom2, containerAtom.getLeafAtomOfType(Atom.TYPE_mvhd), -9223372036854775807L, null, z, this.isQuickTime)) != null) {
    ...
    private int getTrackIndexOfNextReadSample(long j) {
        ...
        return (j2 == Long.MAX_VALUE || !z || j3 < j2 + WebAppInformation.maxCacheSize) ? i3 : i2;
    }
