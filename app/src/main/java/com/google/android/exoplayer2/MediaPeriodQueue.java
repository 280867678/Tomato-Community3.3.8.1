...
final class MediaPeriodQueue {
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (this.length == 0) {
                ...
                this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder2.info.f1313id.windowSequenceNumber;
            }
    ...
    public void clear(boolean z) {
        ...
        if (frontPeriod != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = frontPeriod.info.f1313id.windowSequenceNumber;
            frontPeriod.release();
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo, int i) {
        return getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f1313id.copyWithPeriodIndex(i));
    }
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(int i) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.next) {
            if (frontPeriod.uid.equals(obj)) {
                return frontPeriod.info.f1313id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder frontPeriod2 = getFrontPeriod(); frontPeriod2 != null; frontPeriod2 = frontPeriod2.next) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i2) {
                return frontPeriod2.info.f1313id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodHolder mediaPeriodHolder, MediaPeriodInfo mediaPeriodInfo) {
        ...
        return mediaPeriodInfo2.startPositionUs == mediaPeriodInfo.startPositionUs && mediaPeriodInfo2.endPositionUs == mediaPeriodInfo.endPositionUs && mediaPeriodInfo2.f1313id.equals(mediaPeriodInfo.f1313id);
    }
    ...
    private boolean updateForPlaybackModeChange() {
        ...
        while (true) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(frontPeriod.info.f1313id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            while (true) {
            ...
            if (nextPeriodIndex == -1 || (mediaPeriodHolder = frontPeriod.next) == null || mediaPeriodHolder.info.f1313id.periodIndex != nextPeriodIndex) {
                break;
            }
        ...
        frontPeriod.info = getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f1313id);
        return !removeAfter || !hasPlayingPeriod();
    }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(mediaPeriodInfo.f1313id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (nextPeriodIndex == -1) {
                return null;
            }
            int i2 = this.timeline.getPeriod(nextPeriodIndex, this.period, true).windowIndex;
            Object obj = this.period.uid;
            long j4 = mediaPeriodInfo.f1313id.windowSequenceNumber;
            long j5 = 0;
            if (this.timeline.getWindow(i2, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (mediaPeriodHolder2 != null && mediaPeriodHolder2.uid.equals(obj)) {
                    j3 = mediaPeriodHolder.next.info.f1313id.windowSequenceNumber;
                } else {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f1313id;
    ...
    private MediaPeriodInfo getMediaPeriodInfoForContent(int i, long j, long j2) {
        ...
        return new MediaPeriodInfo(mediaPeriodId, j, adGroupTimeUs, -9223372036854775807L, adGroupTimeUs == Long.MIN_VALUE ? this.period.getDurationUs() : adGroupTimeUs, isLastInPeriod, isLastInTimeline(mediaPeriodId, isLastInPeriod));
    }
