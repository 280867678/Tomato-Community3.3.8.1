...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(int i, int i2, int i3, int i4, @Nullable int[] iArr, int i5, int i6) throws AudioSink.ConfigurationException {
        ...
        if (z3) {
            ...
            for (AudioProcessor audioProcessor : getAvailableAudioProcessors()) {
                try {
                    z |= audioProcessor.configure(i7, i2, i9);
        ...
        switch (i2) {
            ...
            case 7:
                ...
                break;
            case 8:
                i8 = C1868C.CHANNEL_OUT_7POINT1_SURROUND;
                break;
            default:
        ...
        if (Util.SDK_INT <= 23 && "foster".equals(Util.DEVICE) && "NVIDIA".equals(Util.MANUFACTURER)) {
            if (i2 != 3 && i2 != 5) {
                if (i2 == 7) {
                    i10 = C1868C.CHANNEL_OUT_7POINT1_SURROUND;
                }
            }
            if (Util.SDK_INT <= 25 && "fugu".equals(Util.DEVICE) && !this.isInputPcm && i2 == 1) {
                i10 = 12;
            }
            if (z && isInitialized() && this.outputEncoding == i && this.outputSampleRate == i7 && this.outputChannelConfig == i10) {
                return;
            }
            reset();
            ...
            if (i4 == 0) {
                ...
                int minBufferSize = AudioTrack.getMinBufferSize(i7, i10, this.outputEncoding);
                if (minBufferSize == -2) {
                    z2 = false;
                }
                Assertions.checkState(z2);
                this.bufferSize = Util.constrainValue(minBufferSize * 4, ((int) durationUsToFrames(250000L)) * this.outputPcmFrameSize, (int) Math.max(minBufferSize, durationUsToFrames(750000L) * this.outputPcmFrameSize));
                return;
            } else {
    ...
    */
    ...
    private AudioTrack initializeKeepSessionIdAudioTrack(int i) {
        return new AudioTrack(3, CodeState.CODES.CODE_PLAYER_PLAY_ERROR, 4, 2, 2, 0, i);
    }
