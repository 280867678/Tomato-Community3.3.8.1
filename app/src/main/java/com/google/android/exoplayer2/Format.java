...
public final class Format implements Parcelable {
    public static final Parcelable.Creator<Format> CREATOR = new Parcelable.Creator<Format>() { // from class: com.google.android.exoplayer2.Format.1
        ...
        public Format mo6193createFromParcel(Parcel parcel) {
        ...
        public Format[] mo6194newArray(int i) {
            return new Format[i];
        }
    };
    ...
    Format(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, int i, int i2, int i3, int i4, float f, int i5, float f2, @Nullable byte[] bArr, int i6, @Nullable ColorInfo colorInfo, int i7, int i8, int i9, int i10, int i11, int i12, @Nullable String str5, int i13, long j, @Nullable List<byte[]> list, @Nullable DrmInitData drmInitData, @Nullable Metadata metadata) {
        ...
        this.encoderPadding = i11 != -1 ? i11 : i14;
    ...
    Format(Parcel parcel) {
        this.f1312id = parcel.readString();
    ...
    public String toString() {
        return "Format(" + this.f1312id + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }

    public int hashCode() {
        if (this.hashCode == 0) {
            String str = this.f1312id;
            int i = 0;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f1312id);
