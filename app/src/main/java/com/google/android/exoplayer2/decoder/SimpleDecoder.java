...
public abstract class SimpleDecoder<I extends DecoderInputBuffer, O extends OutputBuffer, E extends Exception> implements Decoder<I, O, E> {
    ...
    protected abstract E mo6241createUnexpectedDecodeException(Throwable th);
    ...
    public final I mo6242dequeueInputBuffer() throws Exception {
        I i;
        I i2;
    ...
    public final O mo6243dequeueOutputBuffer() throws Exception {
        synchronized (this.lock) {
            maybeThrowException();
        ...
        synchronized (this.lock) {
            ...
            if (removeFirst.isEndOfStream()) {
                ...
                try {
                    ...
                    this.exception = mo6241createUnexpectedDecodeException(e);
                } catch (RuntimeException e2) {
                    this.exception = mo6241createUnexpectedDecodeException(e2);
                }
