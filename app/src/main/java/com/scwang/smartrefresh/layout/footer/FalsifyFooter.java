...
public class FalsifyFooter extends InternalAbstract implements RefreshFooter {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (isInEditMode()) {
            ...
            textView.setText(getResources().getString(R$string.srl_component_falsify, FalsifyFooter.class.getSimpleName(), Float.valueOf(DensityUtil.px2dp(getHeight()))));
    ...
    public void onInitialized(@NonNull RefreshKernel refreshKernel, int i, int i2) {
        ...
        refreshKernel.getRefreshLayout().mo6486setEnableAutoLoadMore(false);
    }
