...
public class TwoLevelHeader extends InternalAbstract implements RefreshHeader {
    ...
    public void onInitialized(@NonNull RefreshKernel refreshKernel, int i, int i2) {
        ...
        if (((i2 + i) * 1.0f) / i != this.mMaxRage && this.mHeaderHeight == 0) {
            ...
            refreshKernel.getRefreshLayout().mo6488setHeaderMaxDragRate(this.mMaxRage);
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState refreshState, @NonNull RefreshState refreshState2) {
        ...
        if (refreshInternal != null) {
            ...
            int i = C30751.$SwitchMap$com$scwang$smartrefresh$layout$constant$RefreshState[refreshState2.ordinal()];
            boolean z = true;
            if (i == 1) {
    ...
    protected void moveSpinner(int i) {
        ...
        this.mSpinner = i;
        int i2 = C30751.$SwitchMap$com$scwang$smartrefresh$layout$constant$SpinnerStyle[refreshInternal.getSpinnerStyle().ordinal()];
        if (i2 == 1) {
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C30751 {
        static final /* synthetic */ int[] $SwitchMap$com$scwang$smartrefresh$layout$constant$RefreshState;
        static final /* synthetic */ int[] $SwitchMap$com$scwang$smartrefresh$layout$constant$SpinnerStyle = new int[SpinnerStyle.values().length];

        static {
            try {
                $SwitchMap$com$scwang$smartrefresh$layout$constant$SpinnerStyle[SpinnerStyle.Translate.ordinal()] = 1;
