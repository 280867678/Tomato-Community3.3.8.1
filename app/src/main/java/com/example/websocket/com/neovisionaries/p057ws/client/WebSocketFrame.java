...
/* renamed from: com.example.websocket.com.neovisionaries.ws.client.WebSocketFrame */
...
public class WebSocketFrame {
    ...
    public String toString() {
        ...
        String str = "1";
        sb.append(this.mFin ? str : "0");
        sb.append(",RSV1=");
        sb.append(this.mRsv1 ? str : "0");
        sb.append(",RSV2=");
        sb.append(this.mRsv2 ? str : "0");
        sb.append(",RSV3=");
        if (!this.mRsv3) {
            str = "0";
        }
