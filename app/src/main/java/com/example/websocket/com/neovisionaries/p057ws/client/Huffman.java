...
/* renamed from: com.example.websocket.com.neovisionaries.ws.client.Huffman */
...
public class Huffman {
    ...
    public Huffman(int[] iArr) {
        ...
        this.mMaxCodeLen = Misc.max(iArr);
        Object[] objArr = new Object[2];
        this.mMaxCodeValsFromCodeLen = createMaxCodeValsFromCodeLen(createCountsFromCodeLen(iArr, this.mMaxCodeLen), this.mMaxCodeLen, objArr);
