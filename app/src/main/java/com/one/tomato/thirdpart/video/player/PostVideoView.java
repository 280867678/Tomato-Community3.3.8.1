...
import com.one.tomato.thirdpart.video.manager.PostVideoViewManager;

/* loaded from: classes3.dex */
public class PostVideoView extends BaseIjkVideoView {
    ...
    public void startPlay() {
        if (this.mAddToVideoViewManager) {
            PostVideoViewManager.instance().releaseVideoPlayer();
            PostVideoViewManager.instance().setCurrentVideoPlayer(this);
        }
        if (checkNetwork()) {
            return;
        }
    ...
    private void addSurfaceView() {
        ...
        holder.addCallback(new SurfaceHolder.Callback() { // from class: com.one.tomato.thirdpart.video.player.PostVideoView.1
            ...
            public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
                if (((BaseIjkVideoView) PostVideoView.this).mMediaPlayer != null) {
                    ((BaseIjkVideoView) PostVideoView.this).mMediaPlayer.setDisplay(surfaceHolder);
                }
            }
        });
        holder.setFormat(1);
    ...
    private void addTextureView() {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: com.one.tomato.thirdpart.video.player.PostVideoView.2
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
                ...
                SurfaceTexture surfaceTexture2 = postVideoView.mSurfaceTexture;
                if (surfaceTexture2 != null) {
                    postVideoView.mTextureView.setSurfaceTexture(surfaceTexture2);
                    return;
                }
                postVideoView.mSurfaceTexture = surfaceTexture;
                ((BaseIjkVideoView) postVideoView).mMediaPlayer.setSurface(new Surface(surfaceTexture));
            }

            @Override // android.view.TextureView.SurfaceTextureListener
            public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
                return PostVideoView.this.mSurfaceTexture == null;
            }
        });
