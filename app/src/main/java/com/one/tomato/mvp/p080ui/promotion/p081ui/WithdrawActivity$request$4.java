...
/* renamed from: com.one.tomato.mvp.ui.promotion.ui.WithdrawActivity$request$4 */
/* loaded from: classes3.dex */
public final class WithdrawActivity$request$4 implements PromotionUtil.RequestTokenListener {
    ...
    public WithdrawActivity$request$4(WithdrawActivity withdrawActivity) {
    ...
    public void requestTokenSuccess() {
        ...
        ApiImplService.Companion.getApiImplService().requestPromotionWithdrawConfig(PromotionUtil.DOMAIN + "/api/app/promotion/wallet/queryWithDrawConfig", body).compose(RxUtils.schedulersTransformer()).compose(RxUtils.bindToLifecycler((RxAppCompatActivity) this.this$0)).subscribe(new ApiDisposableObserver<PromotionWithdrawConfig>() { // from class: com.one.tomato.mvp.ui.promotion.ui.WithdrawActivity$request$4$requestTokenSuccess$1
            ...
            public void onResult(PromotionWithdrawConfig promotionWithdrawConfig) {
                WithdrawActivity$request$4.this.this$0.promotionWithdrawConfig = promotionWithdrawConfig;
                WithdrawActivity$request$4.this.this$0.initConfigUI();
            }
        });
    }
}
