...
/* renamed from: com.one.tomato.mvp.ui.promotion.ui.IncomeRecordFragment$requestList$1 */
/* loaded from: classes3.dex */
public final class IncomeRecordFragment$requestList$1 implements PromotionUtil.RequestTokenListener {
    final /* synthetic */ IncomeRecordFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    public IncomeRecordFragment$requestList$1(IncomeRecordFragment incomeRecordFragment) {
    ...
    public void requestTokenSuccess() {
        ...
        ApiImplService.Companion.getApiImplService().requestPromotionIncomeRecord(PromotionUtil.DOMAIN + "/api/app/promotion/app/queryPromotionRecord", body).compose(RxUtils.schedulersTransformer()).compose(RxUtils.bindToLifecycler((RxFragment) this.this$0)).subscribe(new Observer<PromotionIncomeRecord>() { // from class: com.one.tomato.mvp.ui.promotion.ui.IncomeRecordFragment$requestList$1$requestTokenSuccess$1
            ...
            @Override // io.reactivex.Observer
            public void onNext(PromotionIncomeRecord t) {
                Intrinsics.checkParameterIsNotNull(t, "t");
                IncomeRecordFragment$requestList$1.this.this$0.updateData(t.data);
            }
            ...
            public void onError(Throwable e) {
                ...
                IncomeRecordFragment$requestList$1.this.this$0.updateDataFail();
            }
        });
    }
