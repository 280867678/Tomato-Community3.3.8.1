...
/* renamed from: com.one.tomato.mvp.ui.promotion.ui.WithdrawActivity$request$3 */
/* loaded from: classes3.dex */
public final class WithdrawActivity$request$3 implements PromotionUtil.RequestTokenListener {
    ...
    public WithdrawActivity$request$3(WithdrawActivity withdrawActivity) {
    ...
    public void requestTokenSuccess() {
        ...
        ApiImplService.Companion.getApiImplService().requestPromotionWalletBalance(PromotionUtil.DOMAIN + "/api/app/promotion/wallet/queryWalletBalance", body).compose(RxUtils.schedulersTransformer()).compose(RxUtils.bindToLifecycler((RxAppCompatActivity) this.this$0)).subscribe(new ApiDisposableObserver<PromotionWalletBalance>() { // from class: com.one.tomato.mvp.ui.promotion.ui.WithdrawActivity$request$3$requestTokenSuccess$1
            ...
            public void onResult(PromotionWalletBalance promotionWalletBalance) {
                WithdrawActivity$request$3.this.this$0.promotionWalletBalance = promotionWalletBalance;
                WithdrawActivity$request$3.this.this$0.initConfigUI();
            }
        });
    }
}
