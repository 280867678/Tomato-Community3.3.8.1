...
public class HttpsUtils {
    public static X509TrustManager UnSafeTrustManager = new X509TrustManager() { // from class: com.one.tomato.mvp.base.okhttp.HttpsUtils.1
    ...
    static {
        new HostnameVerifier() { // from class: com.one.tomato.mvp.base.okhttp.HttpsUtils.2
