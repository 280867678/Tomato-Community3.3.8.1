...
public class BitstreamWriter {
    ...
    /* renamed from: os */
    private final OutputStream f1354os;

    public BitstreamWriter(OutputStream outputStream) {
        this.f1354os = outputStream;
    }
    ...
    private void writeCurByte() throws IOException {
        ...
        this.f1354os.write(iArr[7] | (iArr[0] << 7) | (iArr[1] << 6) | (iArr[2] << 5) | (iArr[3] << 4) | (iArr[4] << 3) | (iArr[5] << 2) | (iArr[6] << 1));
    }
