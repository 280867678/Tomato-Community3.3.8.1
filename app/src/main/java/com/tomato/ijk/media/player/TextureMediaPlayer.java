...
public class TextureMediaPlayer extends MediaPlayerProxy implements IMediaPlayer, ISurfaceTextureHolder {
    ...
    @Override // com.tomato.ijk.media.player.MediaPlayerProxy, com.tomato.ijk.media.player.IMediaPlayer
    public void reset() {
        super.reset();
    ...
    @Override // com.tomato.ijk.media.player.ISurfaceTextureHolder
