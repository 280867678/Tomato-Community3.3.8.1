...
import com.tomato.ijk.media.player.annotations.AccessedByNative;
import com.tomato.ijk.media.player.annotations.CalledByNative;
import com.tomato.ijk.media.player.misc.IAndroidIO;
import com.tomato.ijk.media.player.misc.IMediaDataSource;
import com.tomato.ijk.media.player.misc.IjkTrackInfo;
...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private static final String TAG = "com.tomato.ijk.media.player.IjkMediaPlayer";
    ...
    private static final IjkLibLoader sLocalLibLoader = new IjkLibLoader() { // from class: com.tomato.ijk.media.player.IjkMediaPlayer.1
        @Override // com.tomato.ijk.media.player.IjkLibLoader
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m246w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x008c, code lost:
        android.util.Log.d(com.tomato.ijk.media.player.IjkMediaPlayer.TAG, "Couldn't open file on client side, trying server side");
    ...
    */
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m246w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public IjkTrackInfo[] mo6538getTrackInfo() {
        IjkMediaMeta parse;
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                ...
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i == 1) {
                        ...
                        DebugLog.m252e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                        ...
                        if (message.arg1 == 3) {
                            DebugLog.m250i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                        }
                        ijkMediaPlayer.notifyOnInfo(message.arg1, message.arg2);
                        return;
                    } else if (i != 10001) {
                        DebugLog.m252e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                        return;
                    } else {
            ...
            DebugLog.m246w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
    ...
    @Override // com.tomato.ijk.media.player.AbstractMediaPlayer
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        @Override // com.tomato.ijk.media.player.IjkMediaPlayer.OnMediaCodecSelectListener
        @TargetApi(16)
