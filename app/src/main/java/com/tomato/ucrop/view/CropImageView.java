...
import com.tomato.ucrop.model.CropParameters;
import com.tomato.ucrop.model.ImageState;
import com.tomato.ucrop.task.BitmapCropTask;
import com.tomato.ucrop.util.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    @Override // com.tomato.ucrop.view.TransformImageView
    ...
    public void onImageLaidOut() {
        ...
        if (i5 > i6) {
            this.mCropRect.set((i4 - ((int) (i6 * f))) / 2, 0.0f, i2 + i3, i6);
        } else {
            this.mCropRect.set(0.0f, (i6 - i5) / 2, i4, i5 + i);
        }
