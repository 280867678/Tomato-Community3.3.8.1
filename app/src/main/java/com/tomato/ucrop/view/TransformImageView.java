...
import com.tomato.ucrop.util.FastBitmapDrawable;
...
public class TransformImageView extends ImageView {
    ...
    public void setImageUri(@NonNull Uri uri, @Nullable Uri uri2) throws Exception {
        ...
        BitmapLoadUtils.decodeBitmapInBackground(getContext(), uri, uri2, maxBitmapSize, maxBitmapSize, new BitmapLoadCallback() { // from class: com.tomato.ucrop.view.TransformImageView.1
            @Override // com.tomato.ucrop.callback.BitmapLoadCallback
    ...
    protected float getMatrixValue(@NonNull Matrix matrix, @IntRange(from = 0, m5591to = 9) int i) {
