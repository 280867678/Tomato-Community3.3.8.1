...
public class UCrop {
    ...
    /* renamed from: of */
    public static UCrop m232of(@NonNull Uri uri, @NonNull Uri uri2) {
    ...
    public void start(@NonNull Context context, @NonNull android.support.p002v4.app.Fragment fragment) {
        start(context, fragment, 69);
    }
    ...
    public void start(@NonNull Context context, @NonNull android.support.p002v4.app.Fragment fragment, int i) {
        fragment.startActivityForResult(getIntent(context), i);
    }
