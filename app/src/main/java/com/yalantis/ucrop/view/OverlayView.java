...
public class OverlayView extends View {
    ...
    public OverlayView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTouchPointThreshold = getResources().getDimensionPixelSize(C5127R.dimen.ucrop_default_crop_rect_corner_touch_threshold);
        this.mCropRectMinSize = getResources().getDimensionPixelSize(C5127R.dimen.ucrop_default_crop_rect_min_size);
        this.mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(C5127R.dimen.ucrop_default_crop_rect_corner_touch_area_line_length);
        init();
    }
    ...
    public void processStyledAttributes(@NonNull TypedArray typedArray) {
        this.mCircleDimmedLayer = typedArray.getBoolean(C5127R.styleable.ucrop_UCropView_ucrop_circle_dimmed_layer, false);
        this.mDimmedColor = typedArray.getColor(C5127R.styleable.ucrop_UCropView_ucrop_dimmed_color, getResources().getColor(C5127R.color.ucrop_color_default_dimmed));
        ...
        this.mShowCropFrame = typedArray.getBoolean(C5127R.styleable.ucrop_UCropView_ucrop_show_frame, true);
        initCropGridStyle(typedArray);
        this.mShowCropGrid = typedArray.getBoolean(C5127R.styleable.ucrop_UCropView_ucrop_show_grid, true);
    }

    private void initCropFrameStyle(@NonNull TypedArray typedArray) {
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C5127R.styleable.ucrop_UCropView_ucrop_frame_stroke_size, getResources().getDimensionPixelSize(C5127R.dimen.ucrop_default_crop_frame_stoke_width));
        int color = typedArray.getColor(C5127R.styleable.ucrop_UCropView_ucrop_frame_color, getResources().getColor(C5127R.color.ucrop_color_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray typedArray) {
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C5127R.styleable.ucrop_UCropView_ucrop_grid_stroke_size, getResources().getDimensionPixelSize(C5127R.dimen.ucrop_default_crop_grid_stoke_width));
        int color = typedArray.getColor(C5127R.styleable.ucrop_UCropView_ucrop_grid_color, getResources().getColor(C5127R.color.ucrop_color_default_crop_grid));
        this.mCropGridPaint.setStrokeWidth(dimensionPixelSize);
        this.mCropGridPaint.setColor(color);
        this.mCropGridRowCount = typedArray.getInt(C5127R.styleable.ucrop_UCropView_ucrop_grid_row_count, 2);
        this.mCropGridColumnCount = typedArray.getInt(C5127R.styleable.ucrop_UCropView_ucrop_grid_column_count, 2);
    }
}
