...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mProgressLinePaint.setColor(getResources().getColor(C5127R.color.ucrop_color_progress_wheel_line));
    ...
    private void init() {
        this.mMiddleLineColor = ContextCompat.getColor(getContext(), C5127R.color.ucrop_color_progress_wheel_line);
        this.mProgressLineWidth = getContext().getResources().getDimensionPixelSize(C5127R.dimen.ucrop_width_horizontal_wheel_progress_line);
        this.mProgressLineHeight = getContext().getResources().getDimensionPixelSize(C5127R.dimen.ucrop_height_horizontal_wheel_progress_line);
        this.mProgressLineMargin = getContext().getResources().getDimensionPixelSize(C5127R.dimen.ucrop_margin_horizontal_wheel_progress_line);
