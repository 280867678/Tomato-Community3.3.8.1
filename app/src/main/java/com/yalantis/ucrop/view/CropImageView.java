...
public class CropImageView extends TransformImageView {
    ...
    public void processStyledAttributes(@NonNull TypedArray typedArray) {
        float abs = Math.abs(typedArray.getFloat(C5127R.styleable.ucrop_UCropView_ucrop_aspect_ratio_x, 0.0f));
        float abs2 = Math.abs(typedArray.getFloat(C5127R.styleable.ucrop_UCropView_ucrop_aspect_ratio_y, 0.0f));
