...
public final class MethodProperty extends SettableBeanProperty {
    ...
    public MethodProperty(BeanPropertyDefinition beanPropertyDefinition, JavaType javaType, TypeDeserializer typeDeserializer, Annotations annotations, AnnotatedMethod annotatedMethod) {
        ...
        this._setter = annotatedMethod.mo6089getAnnotated();
    ...
    public void deserializeAndSet(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        try {
            this._setter.invoke(obj, mo6059deserializeWithType);
        } catch (Exception e) {
    ...
    public Object deserializeSetAndReturn(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        try {
            Object invoke = this._setter.invoke(obj, mo6059deserializeWithType);
    ...
    Object readResolve() {
        return new MethodProperty(this, this._annotated.mo6089getAnnotated());
    }
}
