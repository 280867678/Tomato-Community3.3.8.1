...
public class TokenBuffer extends JsonGenerator {
    ...
    public TokenBuffer(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        this._parentContext = jsonParser.mo5969getParsingContext();
        this._generatorFeatures = DEFAULT_GENERATOR_FEATURES;
        this._writeContext = JsonWriteContext.createRootContext(null);
        Segment segment = new Segment();
        this._last = segment;
    ...
    public void serialize(JsonGenerator jsonGenerator) throws IOException {
        ...
        while (true) {
            ...
            switch (C14061.$SwitchMap$com$fasterxml$jackson$core$JsonToken[type.ordinal()]) {
                case 1:
    ...
    public TokenBuffer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        JsonToken nextToken;
        if (jsonParser.getCurrentTokenId() != JsonToken.FIELD_NAME.m4126id()) {
    ...
    public final JsonWriteContext mo6173getOutputContext() {
    ...
    public final void writeEndArray() throws IOException {
        ...
        JsonWriteContext mo5976getParent = this._writeContext.mo5976getParent();
        if (mo5976getParent != null) {
            this._writeContext = mo5976getParent;
        }
    }
    ...
    public void copyCurrentEvent(JsonParser jsonParser) throws IOException {
        ...
        switch (C14061.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonParser.getCurrentToken().ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
            ...
            case 7:
                int i = C14061.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1) {
            ...
            case 8:
                ...
                int i2 = C14061.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i2 == 3) {
                    writeNumber(jsonParser.getDecimalValue());
                    return;
                } else if (i2 == 4) {
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int i = C14061.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i == 1) {
            writeStartObject();
    ...
    public static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation getCurrentLocation() {
            ...
            return jsonLocation == null ? JsonLocation.f1272NA : jsonLocation;
        }
        ...
        public String getCurrentName() {
            ...
            if (jsonToken == JsonToken.START_OBJECT || jsonToken == JsonToken.START_ARRAY) {
                return this._parsingContext.mo5976getParent().getCurrentName();
            }
        ...
        public String getText() {
            ...
            if (jsonToken == JsonToken.VALUE_STRING || jsonToken == JsonToken.FIELD_NAME) {
                ...
                int i = C14061.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()];
                if (i == 7 || i == 8) {
                    return ClassUtil.nullOrToString(_currentObject());
                }
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            int i = C14061.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[getNumberType().ordinal()];
            if (i != 1) {
                if (i == 2) {
