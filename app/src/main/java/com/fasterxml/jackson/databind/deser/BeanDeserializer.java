...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
    ...
    public /* bridge */ /* synthetic */ BeanDeserializerBase mo6011withIgnorableProperties(Set set) {
        return mo6011withIgnorableProperties((Set<String>) set);
    }
    ...
    public BeanDeserializer mo6012withObjectIdReader(ObjectIdReader objectIdReader) {
        return new BeanDeserializer(this, objectIdReader);
    }

    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    /* renamed from: withIgnorableProperties */
    public BeanDeserializer mo6011withIgnorableProperties(Set<String> set) {
    ...
    protected final Object _deserializeOther(JsonParser jsonParser, DeserializationContext deserializationContext, JsonToken jsonToken) throws IOException {
        if (jsonToken != null) {
            switch (C13721.$SwitchMap$com$fasterxml$jackson$core$JsonToken[jsonToken.ordinal()]) {
                case 1:
    ...
    protected Object deserializeWithUnwrapped(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (jsonDeserializer != null) {
            return this._valueInstantiator.createUsingDelegate(deserializationContext, jsonDeserializer.mo6063deserialize(jsonParser, deserializationContext));
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0048, code lost:
        if (r5 != com.fasterxml.jackson.core.JsonToken.FIELD_NAME) goto L18;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x005f, code lost:
        if (r1.getClass() == r7._beanType.getRawClass()) goto L24;
     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0061, code lost:
        r8 = r7._beanType;
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x007b, code lost:
        return r9.reportBadDefinition(r8, java.lang.String.format("Cannot create polymorphic instances with external type ids (%s -> %s)", r8, r1.getClass()));
     */
    /* JADX WARN: Code restructure failed: missing block: B:24:0x007c, code lost:
        r0.complete(r8, r9, r1);
     */
