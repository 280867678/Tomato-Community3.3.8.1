...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
    ...
    public abstract BeanSerializerBase mo6127withFilterId(Object obj);

    /* renamed from: withIgnorals */
    protected abstract BeanSerializerBase mo6119withIgnorals(Set<String> set);
    ...
    protected BeanSerializerBase withIgnorals(String[] strArr) {
        return mo6119withIgnorals(ArrayBuilders.arrayToSet(strArr));
    }
    ...
    private static final BeanPropertyWriter[] rename(BeanPropertyWriter[] beanPropertyWriterArr, NameTransformer nameTransformer) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (beanPropertyWriter != null) {
                beanPropertyWriterArr2[i] = beanPropertyWriter.mo6122rename(nameTransformer);
            }
        }
        ...
        for (int i = 0; i < length2; i++) {
            ...
            if (!beanPropertyWriter3.hasSerializer()) {
                ...
                if (findConvertingSerializer == null) {
                    ...
                    findConvertingSerializer = (!serializationType.isContainerType() || (typeSerializer = (TypeSerializer) serializationType.mo6160getContentType().getTypeHandler()) == null || !(findValueSerializer instanceof ContainerSerializer)) ? findValueSerializer : ((ContainerSerializer) findValueSerializer).withValueTypeSerializer(typeSerializer);
                }
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (findFormatOverrides == null || !findFormatOverrides.hasShape()) {
            ...
            if (shape != JsonFormat.Shape.ANY && shape != this._serializationShape) {
                if (this._handledType.isEnum()) {
                    int i2 = C13971.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[shape.ordinal()];
                    if (i2 == 1 || i2 == 2 || i2 == 3) {
                        return serializerProvider.handlePrimaryContextualization(EnumSerializer.construct(this._beanType.getRawClass(), serializerProvider.mo6006getConfig(), mo6006getConfig.introspectClassAnnotations(this._beanType), findFormatOverrides), beanProperty);
                    }
        ...
        if (set != null && !set.isEmpty()) {
            withObjectIdWriter = withObjectIdWriter.mo6119withIgnorals(set);
        }
        if (obj != null) {
            withObjectIdWriter = withObjectIdWriter.mo6127withFilterId(obj);
        }
        if (shape == null) {
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) throws JsonMappingException {
        ...
        if (jsonSerializableSchema != null && (m4120id = jsonSerializableSchema.m4120id()) != null && m4120id.length() > 0) {
            createSchemaNode.put(DatabaseFieldConfigLoader.FIELD_NAME_ID, m4120id);
        }
