...
public class ObjectWriter implements Versioned, Serializable {
    ...
    public ObjectWriter(ObjectMapper objectMapper, SerializationConfig serializationConfig, JavaType javaType, PrettyPrinter prettyPrinter) {
        ...
        if (javaType == null || javaType.hasRawClass(Object.class)) {
            ...
            this._prefetch = Prefetch.empty.forRootType(this, javaType.mo6168withStaticTyping());
        }
    }
    ...
    protected ObjectWriter(ObjectWriter objectWriter, JsonFactory jsonFactory) {
        this._config = objectWriter._config.mo6008with(MapperFeature.SORT_PROPERTIES_ALPHABETICALLY, jsonFactory.requiresPropertyOrdering());
        this._serializerProvider = objectWriter._serializerProvider;
        this._serializerFactory = objectWriter._serializerFactory;
    ...
    protected SequenceWriter _newSequenceWriter(boolean z, JsonGenerator jsonGenerator, boolean z2) throws IOException {
        ...
        SequenceWriter sequenceWriter = new SequenceWriter(_serializerProvider(), jsonGenerator, z2, this._prefetch);
        sequenceWriter.init(z);
    ...
    public ObjectWriter with(DateFormat dateFormat) {
        return _new(this, this._config.mo6003with(dateFormat));
    }
    ...
    public ObjectWriter withRootName(PropertyName propertyName) {
        return _new(this, this._config.mo6004withRootName(propertyName));
    }

    public ObjectWriter withoutRootName() {
        return _new(this, this._config.mo6004withRootName(PropertyName.NO_NAME));
    }
    ...
    public ObjectWriter withView(Class<?> cls) {
        return _new(this, this._config.mo6005withView(cls));
    }
    ...
    public ObjectWriter with(ContextAttributes contextAttributes) {
        return _new(this, this._config.mo6001with(contextAttributes));
    }
    ...
    protected DefaultSerializerProvider _serializerProvider() {
        return this._serializerProvider.mo6117createInstance(this._config, this._serializerFactory);
    }
            ...
            if (prettyPrinter != null) {
                if (prettyPrinter == ObjectWriter.NULL_PRETTY_PRINTER) {
                    ...
                    if (prettyPrinter instanceof Instantiatable) {
                        prettyPrinter = (PrettyPrinter) ((Instantiatable) prettyPrinter).mo5977createInstance();
                    }
