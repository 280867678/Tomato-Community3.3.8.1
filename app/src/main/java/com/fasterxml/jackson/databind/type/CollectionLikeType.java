...
public class CollectionLikeType extends TypeBase {
    ...
    public CollectionLikeType mo6169withTypeHandler(Object obj) {
    ...
    public CollectionLikeType mo6162withContentTypeHandler(Object obj) {
        return new CollectionLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType.mo6169withTypeHandler(obj), this._valueHandler, this._typeHandler, this._asStatic);
    }

    @Override // com.fasterxml.jackson.databind.JavaType
    /* renamed from: withValueHandler  reason: collision with other method in class */
    public CollectionLikeType mo6170withValueHandler(Object obj) {
    ...
    public CollectionLikeType mo6167withContentValueHandler(Object obj) {
        return new CollectionLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType.mo6170withValueHandler(obj), this._valueHandler, this._typeHandler, this._asStatic);
    }
    ...
    public JavaType withHandlersFrom(JavaType javaType) {
        ...
        return (mo6160getContentType == null || (withHandlersFrom = this._elementType.withHandlersFrom(mo6160getContentType)) == this._elementType) ? withHandlersFrom2 : withHandlersFrom2.withContentType(withHandlersFrom);
    }

    @Override // com.fasterxml.jackson.databind.JavaType
    /* renamed from: withStaticTyping  reason: collision with other method in class */
    public CollectionLikeType mo6168withStaticTyping() {
        return this._asStatic ? this : new CollectionLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType.mo6168withStaticTyping(), this._valueHandler, this._typeHandler, true);
    }
