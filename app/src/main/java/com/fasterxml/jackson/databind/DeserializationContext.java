...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
    ...
    public DeserializationConfig mo6006getConfig() {
        return this._config;
    }
    ...
    public DeserializationContext mo6007setAttribute(Object obj, Object obj2) {
    ...
    public JsonDeserializer<?> handlePrimaryContextualization(JsonDeserializer<?> jsonDeserializer, BeanProperty beanProperty, JavaType javaType) throws JsonMappingException {
        if (jsonDeserializer instanceof ContextualDeserializer) {
            ...
            try {
                jsonDeserializer = ((ContextualDeserializer) jsonDeserializer).mo6018createContextual(this, beanProperty);
            } finally {
    ...
    public <T> T readValue(JsonParser jsonParser, JavaType javaType) throws IOException {
        ...
        return (T) findRootValueDeserializer.mo6063deserialize(jsonParser, this);
    }
    ...
    public <T> T readPropertyValue(JsonParser jsonParser, BeanProperty beanProperty, JavaType javaType) throws IOException {
        ...
        return (T) findContextualValueDeserializer.mo6063deserialize(jsonParser, this);
    }
    ...
    public JsonMappingException instantiationException(Class<?> cls, Throwable th) {
        ...
        InvalidDefinitionException from = InvalidDefinitionException.from(this._parser, String.format("Cannot construct instance of %s, problem: %s", ClassUtil.nameOf(cls), exceptionMessage), constructType);
        from.initCause(th);
        return from;
    }
