...
public abstract class SettableBeanProperty extends ConcreteBeanPropertyBase implements Serializable {
    ...
    public final Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        if (jsonParser.hasToken(JsonToken.VALUE_NULL)) {
            return this._nullProvider.mo6027getNullValue(deserializationContext);
        }
        TypeDeserializer typeDeserializer = this._valueTypeDeserializer;
        if (typeDeserializer != null) {
            return this._valueDeserializer.mo6059deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
        }
        Object mo6063deserialize = this._valueDeserializer.mo6063deserialize(jsonParser, deserializationContext);
        return mo6063deserialize == null ? this._nullProvider.mo6027getNullValue(deserializationContext) : mo6063deserialize;
    }
    ...
    public final Object deserializeWith(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        if (jsonParser.hasToken(JsonToken.VALUE_NULL)) {
            return NullsConstantProvider.isSkipper(this._nullProvider) ? obj : this._nullProvider.mo6027getNullValue(deserializationContext);
        }
        ...
        return deserialize == null ? NullsConstantProvider.isSkipper(this._nullProvider) ? obj : this._nullProvider.mo6027getNullValue(deserializationContext) : deserialize;
    }
