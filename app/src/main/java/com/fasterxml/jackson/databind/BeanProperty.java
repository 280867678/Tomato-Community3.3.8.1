...
public interface BeanProperty extends Named {
    ...
    public static class Std implements BeanProperty, Serializable {
        ...
        public JsonFormat.Value findFormatOverrides(AnnotationIntrospector annotationIntrospector) {
            ...
            AnnotatedMember annotatedMember = this._member;
            return (annotatedMember == null || annotationIntrospector == null || (findFormat = annotationIntrospector.findFormat(annotatedMember)) == null) ? BeanProperty.EMPTY_FORMAT : findFormat;
        }
