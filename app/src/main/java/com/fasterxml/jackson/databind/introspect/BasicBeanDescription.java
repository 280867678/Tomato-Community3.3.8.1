...
public class BasicBeanDescription extends BeanDescription {
    ...
    public Object instantiateBean(boolean z) {
        ...
        try {
            return defaultConstructor.mo6089getAnnotated().newInstance(new Object[0]);
        } catch (Exception e) {
            e = e;
            ...
            throw new IllegalArgumentException("Failed to instantiate bean of type " + this._classInfo.mo6089getAnnotated().getName() + ": (" + e.getClass().getName() + ") " + ClassUtil.exceptionMessage(e), e);
        }
    }
            ...
            if (annotatedConstructor.getParameterCount() == 1) {
                ...
                for (Class<?> cls : clsArr) {
                    if (cls == rawParameterType) {
                        return annotatedConstructor.mo6089getAnnotated();
                    }
                }
                continue;
            }
            ...
            if (isFactoryMethod(annotatedMethod) && annotatedMethod.getParameterCount() == 1) {
                ...
                for (Class<?> cls : clsArr) {
                    if (rawParameterType.isAssignableFrom(cls)) {
                        return annotatedMethod.mo6089getAnnotated();
                    }
                }
                continue;
            }
