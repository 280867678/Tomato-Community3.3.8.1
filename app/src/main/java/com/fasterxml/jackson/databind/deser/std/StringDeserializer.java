...
public class StringDeserializer extends StdScalarDeserializer<String> {
    ...
    public String mo6059deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) throws IOException {
