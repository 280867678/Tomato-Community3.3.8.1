...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    protected final JsonTypeInfo.EnumC1365As _inclusion;
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2) {
        this(javaType, typeIdResolver, str, z, javaType2, JsonTypeInfo.EnumC1365As.PROPERTY);
    }

    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z, JavaType javaType2, JsonTypeInfo.EnumC1365As enumC1365As) {
        super(javaType, typeIdResolver, str, z, javaType2);
        this._inclusion = enumC1365As;
    }
    ...
    protected Object _deserializeTypedForId(JsonParser jsonParser, DeserializationContext deserializationContext, TokenBuffer tokenBuffer) throws IOException {
        ...
        jsonParser.nextToken();
        return _findDeserializer.mo6063deserialize(jsonParser, deserializationContext);
    }
    ...
    protected Object _deserializeTypedUsingDefaultImpl(JsonParser jsonParser, DeserializationContext deserializationContext, TokenBuffer tokenBuffer) throws IOException {
        ...
        return _findDefaultImplDeserializer.mo6063deserialize(jsonParser, deserializationContext);
    }
