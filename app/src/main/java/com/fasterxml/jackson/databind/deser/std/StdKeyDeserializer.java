...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    public Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
        ...
        try {
            ...
            if (this._keyClass.isEnum() && deserializationContext.mo6006getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
                return null;
            }
    ...
    protected Object _parse(String str, DeserializationContext deserializationContext) throws Exception {
        switch (this._kind) {
            ...
            case 9:
                try {
                    return this._deser.mo6062_deserialize(str, deserializationContext);
            ...
            case 17:
                try {
                    return deserializationContext.mo6006getConfig().getBase64Variant().decode(str);
    ...
    static final class DelegatingKD extends KeyDeserializer implements Serializable {
        ...
        public final Object deserializeKey(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            try {
                ...
                asParser.nextToken();
                Object mo6063deserialize = this._delegate.mo6063deserialize(asParser, deserializationContext);
                return mo6063deserialize != null ? mo6063deserialize : deserializationContext.handleWeirdKey(this._keyClass, str, "not a valid representation", new Object[0]);
            } catch (Exception e) {
    ...
    static final class EnumKD extends StdKeyDeserializer {
        ...
        public Object _parse(String str, DeserializationContext deserializationContext) throws IOException {
            ...
            return !deserializationContext.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL) ? deserializationContext.handleWeirdKey(this._keyClass, str, "not one of values excepted for Enum class: %s", _getToStringResolver.getEnumIds()) : findEnum;
        }
