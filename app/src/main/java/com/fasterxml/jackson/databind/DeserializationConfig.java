...
public final class DeserializationConfig extends MapperConfigBase<DeserializationFeature, DeserializationConfig> implements Serializable {
    ...
    public /* bridge */ /* synthetic */ DeserializationConfig mo6005withView(Class cls) {
    ...
    public final DeserializationConfig mo5999_withBase(BaseSettings baseSettings) {
    ...
    public final DeserializationConfig mo6000_withMapperFeatures(int i) {
    ...
    @Override // com.fasterxml.jackson.databind.cfg.MapperConfigBase
    /* renamed from: with */
    public DeserializationConfig mo6002with(SubtypeResolver subtypeResolver) {
    ...
    public DeserializationConfig mo6004withRootName(PropertyName propertyName) {
    ...
    public DeserializationConfig mo6005withView(Class<?> cls) {
    ...
    @Override // com.fasterxml.jackson.databind.cfg.MapperConfigBase
    /* renamed from: with */
    public DeserializationConfig mo6001with(ContextAttributes contextAttributes) {
    ...
    public <T extends BeanDescription> T introspect(JavaType javaType) {
        return (T) getClassIntrospector().mo6075forDeserialization(this, javaType, this);
    }

    public <T extends BeanDescription> T introspectForCreation(JavaType javaType) {
        return (T) getClassIntrospector().mo6074forCreation(this, javaType, this);
    }

    public <T extends BeanDescription> T introspectForBuilder(JavaType javaType) {
        return (T) getClassIntrospector().mo6076forDeserializationWithBuilder(this, javaType, this);
    }
