...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    public VisibilityChecker<?> findAutoDetectVisibility(AnnotatedClass annotatedClass, VisibilityChecker<?> visibilityChecker) {
        ...
        return jsonAutoDetect == null ? visibilityChecker : visibilityChecker.mo6091with(jsonAutoDetect);
    }
    ...
    public TypeResolverBuilder<?> findPropertyContentTypeResolver(MapperConfig<?> mapperConfig, AnnotatedMember annotatedMember, JavaType javaType) {
        if (javaType.mo6160getContentType() == null) {
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int i = C13751.f1280xfdbfedae[jsonSerialize.include().ordinal()];
            if (i == 1) {
    ...
    public static /* synthetic */ class C13751 {
        ...
        static final /* synthetic */ int[] f1280xfdbfedae = new int[JsonSerialize.Inclusion.values().length];

        static {
            try {
                f1280xfdbfedae[JsonSerialize.Inclusion.ALWAYS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f1280xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1280xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1280xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1280xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        JavaType mo6168withStaticTyping;
        JavaType mo6168withStaticTyping2;
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonSerialize jsonSerialize = (JsonSerialize) _findAnnotation(annotated, JsonSerialize.class);
        Class<?> _classIfExplicit = jsonSerialize == null ? null : _classIfExplicit(jsonSerialize.m4122as());
        if (_classIfExplicit != null) {
            if (javaType.hasRawClass(_classIfExplicit)) {
                javaType = javaType.mo6168withStaticTyping();
            } else {
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (_classIfExplicit2 != null) {
                if (mo6146getKeyType.hasRawClass(_classIfExplicit2)) {
                    mo6168withStaticTyping2 = mo6146getKeyType.mo6168withStaticTyping();
                } else {
                    Class<?> rawClass2 = mo6146getKeyType.getRawClass();
                    try {
                        if (_classIfExplicit2.isAssignableFrom(rawClass2)) {
                            mo6168withStaticTyping2 = typeFactory.constructGeneralizedType(mo6146getKeyType, _classIfExplicit2);
                        } else if (rawClass2.isAssignableFrom(_classIfExplicit2)) {
                            mo6168withStaticTyping2 = typeFactory.constructSpecializedType(mo6146getKeyType, _classIfExplicit2);
                        } else if (_primitiveAndWrapper(rawClass2, _classIfExplicit2)) {
                            mo6168withStaticTyping2 = mo6146getKeyType.mo6168withStaticTyping();
                        } else {
                            throw new JsonMappingException((Closeable) null, String.format("Cannot refine serialization key type %s into %s; types not related", mo6146getKeyType, _classIfExplicit2.getName()));
                        }
                ...
                javaType = ((MapLikeType) javaType).mo6154withKeyType(mo6168withStaticTyping2);
            }
        }
        JavaType mo6160getContentType = javaType.mo6160getContentType();
        if (mo6160getContentType != null) {
            Class<?> _classIfExplicit3 = jsonSerialize == null ? null : _classIfExplicit(jsonSerialize.contentAs());
            if (_classIfExplicit3 == null) {
                return javaType;
            }
            if (mo6160getContentType.hasRawClass(_classIfExplicit3)) {
                mo6168withStaticTyping = mo6160getContentType.mo6168withStaticTyping();
            } else {
                Class<?> rawClass3 = mo6160getContentType.getRawClass();
                try {
                    if (_classIfExplicit3.isAssignableFrom(rawClass3)) {
                        mo6168withStaticTyping = typeFactory.constructGeneralizedType(mo6160getContentType, _classIfExplicit3);
                    } else if (rawClass3.isAssignableFrom(_classIfExplicit3)) {
                        mo6168withStaticTyping = typeFactory.constructSpecializedType(mo6160getContentType, _classIfExplicit3);
                    } else if (_primitiveAndWrapper(rawClass3, _classIfExplicit3)) {
                        mo6168withStaticTyping = mo6160getContentType.mo6168withStaticTyping();
                    } else {
                        throw new JsonMappingException((Closeable) null, String.format("Cannot refine serialization content type %s into %s; types not related", mo6160getContentType, _classIfExplicit3.getName()));
                    }
            ...
            return javaType.withContentType(mo6168withStaticTyping);
        }
        return javaType;
    }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        TypeFactory typeFactory = mapperConfig.getTypeFactory();
        JsonDeserialize jsonDeserialize = (JsonDeserialize) _findAnnotation(annotated, JsonDeserialize.class);
        Class<?> _classIfExplicit = jsonDeserialize == null ? null : _classIfExplicit(jsonDeserialize.m4123as());
        ...
        if (javaType.isMapLikeType()) {
            ...
            if (_classIfExplicit2 != null && !_primitiveAndWrapper(mo6146getKeyType, _classIfExplicit2)) {
                try {
                    javaType = ((MapLikeType) javaType).mo6154withKeyType(typeFactory.constructSpecializedType(mo6146getKeyType, _classIfExplicit2));
                } catch (IllegalArgumentException e2) {
        ...
        if (mo6160getContentType != null) {
            ...
            if (_classIfExplicit3 == null || _primitiveAndWrapper(mo6160getContentType, _classIfExplicit3)) {
                return javaType;
            }
            try {
                return javaType.withContentType(typeFactory.constructSpecializedType(mo6160getContentType, _classIfExplicit3));
            } catch (IllegalArgumentException e3) {
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC1366Id.NONE) {
        ...
        JsonTypeInfo.EnumC1365As include = jsonTypeInfo.include();
        if (include == JsonTypeInfo.EnumC1365As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            include = JsonTypeInfo.EnumC1365As.PROPERTY;
        }
