...
public final class StringArrayDeserializer extends StdDeserializer<String[]> implements ContextualDeserializer {
    ...
    public String[] mo6063deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
                    ...
                    if (currentToken != JsonToken.END_ARRAY) {
                        if (currentToken == JsonToken.VALUE_NULL) {
                            if (!this._skipNullValues) {
                                nextTextValue = (String) this._nullProvider.mo6027getNullValue(deserializationContext);
                            }
                        } else {
            ...
            try {
                if (jsonParser.nextTextValue() == null) {
                    ...
                    if (currentToken != JsonToken.END_ARRAY) {
                        if (currentToken == JsonToken.VALUE_NULL) {
                            if (!this._skipNullValues) {
                                mo6063deserialize = (String) this._nullProvider.mo6027getNullValue(deserializationContext);
                            }
                        } else {
                ...
                resetAndStart[length] = mo6063deserialize;
                length = i;
            } catch (Exception e2) {
                e = e2;
                length = i;
