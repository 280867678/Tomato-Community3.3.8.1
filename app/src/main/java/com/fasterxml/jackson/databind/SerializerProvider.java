...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public final SerializationConfig mo6006getConfig() {
        return this._config;
    }
    ...
    public SerializerProvider mo6007setAttribute(Object obj, Object obj2) {
    ...
    public JsonSerializer<Object> findTypedValueSerializer(Class<?> cls, boolean z, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (createTypeSerializer != null) {
            findValueSerializer = new TypeWrappedSerializer(createTypeSerializer.mo6104forProperty(beanProperty), findValueSerializer);
        }
        if (z) {
