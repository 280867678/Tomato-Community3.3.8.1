...
public abstract class AnnotatedMember extends Annotated implements Serializable {
    ...
    public abstract Member mo6070getMember();
    ...
    public abstract Annotated mo6072withAnnotations(AnnotationMap annotationMap);
    ...
    public final void fixAccess(boolean z) {
        Member mo6070getMember = mo6070getMember();
        if (mo6070getMember != null) {
            ClassUtil.checkAndFixAccess(mo6070getMember, z);
        }
    }
}
