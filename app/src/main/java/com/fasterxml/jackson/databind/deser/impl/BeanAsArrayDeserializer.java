...
public class BeanAsArrayDeserializer extends BeanDeserializerBase {
    ...
    public BeanDeserializerBase mo6012withObjectIdReader(ObjectIdReader objectIdReader) {
        return new BeanAsArrayDeserializer(this._delegate.mo6012withObjectIdReader(objectIdReader), this._orderedProperties);
    }

    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    /* renamed from: withIgnorableProperties */
    public BeanDeserializerBase mo6011withIgnorableProperties(Set<String> set) {
        return new BeanAsArrayDeserializer(this._delegate.mo6011withIgnorableProperties(set), this._orderedProperties);
    }
