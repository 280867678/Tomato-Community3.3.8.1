...
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
    ...
    protected ObjectReader(ObjectReader objectReader, JsonFactory jsonFactory) {
        this._config = objectReader._config.mo6008with(MapperFeature.SORT_PROPERTIES_ALPHABETICALLY, jsonFactory.requiresPropertyOrdering());
        this._context = objectReader._context;
        this._rootDeserializers = objectReader._rootDeserializers;
    ...
    /* renamed from: at */
    public ObjectReader m4124at(String str) {
        return new ObjectReader(this, new JsonPointerBasedFilter(str));
    }

    /* renamed from: at */
    public ObjectReader m4125at(JsonPointer jsonPointer) {
    ...
    public ObjectReader withRootName(PropertyName propertyName) {
        return _with(this._config.mo6004withRootName(propertyName));
    }

    public ObjectReader withoutRootName() {
        return _with(this._config.mo6004withRootName(PropertyName.NO_NAME));
    }
    ...
    public ObjectReader withView(Class<?> cls) {
        return _with(this._config.mo6005withView(cls));
    }
    ...
    public ObjectReader with(ContextAttributes contextAttributes) {
        return _with(this._config.mo6001with(contextAttributes));
    }
    ...
    public <T> Iterator<T> mo5995readValues(JsonParser jsonParser, Class<T> cls) throws IOException {
        return forType((Class<?>) cls).readValues(jsonParser);
    }

    @Override // com.fasterxml.jackson.core.ObjectCodec
    /* renamed from: readValues */
    public <T> Iterator<T> mo5994readValues(JsonParser jsonParser, TypeReference<?> typeReference) throws IOException {
        return forType(typeReference).readValues(jsonParser);
    }

    @Override // com.fasterxml.jackson.core.ObjectCodec
    /* renamed from: readValues */
    public <T> Iterator<T> mo5993readValues(JsonParser jsonParser, ResolvedType resolvedType) throws IOException {
    ...
    protected Object _bind(JsonParser jsonParser, Object obj) throws IOException {
        ...
        if (_initForReading == JsonToken.VALUE_NULL) {
            if (obj == null) {
                obj = _findRootDeserializer(createDeserializationContext).mo6027getNullValue(createDeserializationContext);
            }
    ...
    protected final JsonNode _bindAsTree(JsonParser jsonParser) throws IOException {
        ...
        if (currentToken == JsonToken.VALUE_NULL) {
            return createDeserializationContext.getNodeFactory().m6108nullNode();
        }
        ...
        if (this._unwrapRoot) {
            ...
            Object mo6063deserialize = _findTreeDeserializer.mo6063deserialize(jsonParser, createDeserializationContext);
            if (this._config.isEnabled(DeserializationFeature.FAIL_ON_TRAILING_TOKENS)) {
                _verifyNoTrailingTokens(jsonParser, createDeserializationContext, JSON_NODE_TYPE);
            }
            obj = mo6063deserialize;
        }
        return (JsonNode) obj;
    }
