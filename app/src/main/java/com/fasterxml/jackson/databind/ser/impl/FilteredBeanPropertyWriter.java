...
public abstract class FilteredBeanPropertyWriter {
    ...
    private static final class SingleView extends BeanPropertyWriter implements Serializable {
        ...
        public SingleView mo6122rename(NameTransformer nameTransformer) {
            return new SingleView(this._delegate.mo6122rename(nameTransformer), this._view);
        }
    ...
    private static final class MultiView extends BeanPropertyWriter implements Serializable {
        ...
        @Override // com.fasterxml.jackson.databind.ser.BeanPropertyWriter
        /* renamed from: rename  reason: collision with other method in class */
        public MultiView mo6122rename(NameTransformer nameTransformer) {
            return new MultiView(this._delegate.mo6122rename(nameTransformer), this._views);
        }
