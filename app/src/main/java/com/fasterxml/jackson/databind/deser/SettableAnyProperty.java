...
public class SettableAnyProperty implements Serializable {
    ...
    Object readResolve() {
        ...
        if (annotatedMember == null || annotatedMember.mo6089getAnnotated() == null) {
    ...
    public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        if (jsonParser.getCurrentToken() == JsonToken.VALUE_NULL) {
            return this._valueDeserializer.mo6027getNullValue(deserializationContext);
        }
        ...
        return this._valueDeserializer.mo6063deserialize(jsonParser, deserializationContext);
    }
