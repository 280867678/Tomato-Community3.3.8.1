...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, ValueInstantiator.Gettable, Serializable {
    ...
    public abstract BeanDeserializerBase mo6011withIgnorableProperties(Set<String> set);

    /* renamed from: withObjectIdReader */
    public abstract BeanDeserializerBase mo6012withObjectIdReader(ObjectIdReader objectIdReader);
    ...
    public void resolve(DeserializationContext deserializationContext) throws JsonMappingException {
        ...
        if (this._valueInstantiator.canCreateFromObjectWith()) {
            settableBeanPropertyArr = this._valueInstantiator.getFromObjectArguments(deserializationContext.mo6006getConfig());
        ...
        while (it3.hasNext()) {
            ...
            if (_findPropertyUnwrapper != null && (unwrappingDeserializer = (valueDeserializer = _resolveManagedReferenceProperty.getValueDeserializer()).unwrappingDeserializer(_findPropertyUnwrapper)) != valueDeserializer && unwrappingDeserializer != null) {
                ...
                if (_resolveInnerClassValuedProperty.hasValueTypeDeserializer()) {
                    ...
                    if (valueTypeDeserializer.getTypeInclusion() == JsonTypeInfo.EnumC1365As.EXTERNAL_PROPERTY) {
                        if (builder == null) {
    ...
    private JsonDeserializer<Object> _findDelegateDeserializer(DeserializationContext deserializationContext, JavaType javaType, AnnotatedWithParams annotatedWithParams) throws JsonMappingException {
        ...
        if (typeDeserializer == null) {
            typeDeserializer = deserializationContext.mo6006getConfig().findTypeDeserializer(javaType);
        }
    ...
    public JsonDeserializer<?> mo6018createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws JsonMappingException {
        ...
        BeanDeserializerBase mo6012withObjectIdReader = (objectIdReader == null || objectIdReader == this._objectIdReader) ? this : mo6012withObjectIdReader(objectIdReader);
        if (member != null && (findPropertyIgnorals = annotationIntrospector.findPropertyIgnorals(member)) != null) {
            Set<String> findIgnoredForDeserialization = findPropertyIgnorals.findIgnoredForDeserialization();
            if (!findIgnoredForDeserialization.isEmpty()) {
                Set<String> set = mo6012withObjectIdReader._ignorableProps;
                if (set != null && !set.isEmpty()) {
                    HashSet hashSet = new HashSet(findIgnoredForDeserialization);
                    hashSet.addAll(set);
                    findIgnoredForDeserialization = hashSet;
                }
                mo6012withObjectIdReader = mo6012withObjectIdReader.mo6011withIgnorableProperties(findIgnoredForDeserialization);
            }
        }
        ...
        if (findFormatOverrides != null) {
            ...
            if (feature != null && (withCaseInsensitivity = (beanPropertyMap = this._beanProperties).withCaseInsensitivity(feature.booleanValue())) != beanPropertyMap) {
                mo6012withObjectIdReader = mo6012withObjectIdReader.withBeanProperties(withCaseInsensitivity);
            }
        }
        if (shape == null) {
            shape = this._serializationShape;
        }
        return shape == JsonFormat.Shape.ARRAY ? mo6012withObjectIdReader.asArrayDeserializer() : mo6012withObjectIdReader;
    }
    ...
    protected SettableBeanProperty _resolveMergeAndNullSettings(DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty, PropertyMetadata propertyMetadata) throws JsonMappingException {
        ...
        if (mergeInfo != null) {
            JsonDeserializer<Object> valueDeserializer = settableBeanProperty.getValueDeserializer();
            Boolean supportsUpdate = valueDeserializer.supportsUpdate(deserializationContext.mo6006getConfig());
    ...
    protected Object _convertObjectId(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj, JsonDeserializer<Object> jsonDeserializer) throws IOException {
        ...
        asParser.nextToken();
        return jsonDeserializer.mo6063deserialize(asParser, deserializationContext);
    }
    ...
    public Object deserializeFromObjectUsingNonDefault(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (_delegateDeserializer != null) {
            return this._valueInstantiator.createUsingDelegate(deserializationContext, _delegateDeserializer.mo6063deserialize(jsonParser, deserializationContext));
        }
    ...
    public Object deserializeFromNumber(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (numberType == JsonParser.NumberType.INT) {
            if (_delegateDeserializer != null && !this._valueInstantiator.canCreateFromInt()) {
                Object createUsingDelegate = this._valueInstantiator.createUsingDelegate(deserializationContext, _delegateDeserializer.mo6063deserialize(jsonParser, deserializationContext));
            ...
            if (_delegateDeserializer != null) {
                Object createUsingDelegate2 = this._valueInstantiator.createUsingDelegate(deserializationContext, _delegateDeserializer.mo6063deserialize(jsonParser, deserializationContext));
                if (this._injectables != null) {
            ...
            Object createUsingDelegate3 = this._valueInstantiator.createUsingDelegate(deserializationContext, _delegateDeserializer.mo6063deserialize(jsonParser, deserializationContext));
            if (this._injectables != null) {
    ...
    public Object deserializeFromDouble(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (_delegateDeserializer2 != null) {
            return this._valueInstantiator.createUsingDelegate(deserializationContext, _delegateDeserializer2.mo6063deserialize(jsonParser, deserializationContext));
        }
        return deserializationContext.handleMissingInstantiator(handledType(), getValueInstantiator(), jsonParser, "no suitable creator method found to deserialize from Number value (%s)", jsonParser.getNumberValue());
    }
    ...
    public Object deserializeFromArray(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (jsonDeserializer != null || (jsonDeserializer = this._delegateDeserializer) != null) {
            Object createUsingArrayDelegate = this._valueInstantiator.createUsingArrayDelegate(deserializationContext, jsonDeserializer.mo6063deserialize(jsonParser, deserializationContext));
            if (this._injectables != null) {
