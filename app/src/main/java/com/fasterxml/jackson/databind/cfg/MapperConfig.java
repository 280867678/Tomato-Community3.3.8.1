...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver, Serializable {
    ...
    /* renamed from: with */
    public abstract T mo6008with(MapperFeature mapperFeature, boolean z);

    /* renamed from: with */
    public abstract T mo6009with(MapperFeature... mapperFeatureArr);

    /* renamed from: without */
    public abstract T mo6010without(MapperFeature... mapperFeatureArr);
    ...
    public BeanDescription introspectClassAnnotations(JavaType javaType) {
        return getClassIntrospector().mo6073forClassAnnotations(this, javaType, this);
    }
    ...
    public final BeanDescription introspectDirectClassAnnotations(JavaType javaType) {
        return getClassIntrospector().mo6077forDirectClassAnnotations(this, javaType, this);
    }
