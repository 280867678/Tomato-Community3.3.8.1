...
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> implements Serializable {
    ...
    public /* bridge */ /* synthetic */ SerializationConfig mo6005withView(Class cls) {
        return mo6005withView((Class<?>) cls);
    }
    ...
    public final SerializationConfig mo5999_withBase(BaseSettings baseSettings) {
    ...
    public final SerializationConfig mo6000_withMapperFeatures(int i) {
    ...
    public SerializationConfig mo6004withRootName(PropertyName propertyName) {
    ...
    @Override // com.fasterxml.jackson.databind.cfg.MapperConfigBase
    /* renamed from: with */
    public SerializationConfig mo6002with(SubtypeResolver subtypeResolver) {
    ...
    public SerializationConfig mo6005withView(Class<?> cls) {
    ...
    @Override // com.fasterxml.jackson.databind.cfg.MapperConfigBase
    /* renamed from: with */
    public SerializationConfig mo6001with(ContextAttributes contextAttributes) {
    ...
    @Override // com.fasterxml.jackson.databind.cfg.MapperConfigBase
    /* renamed from: with */
    public SerializationConfig mo6003with(DateFormat dateFormat) {
        SerializationConfig serializationConfig = (SerializationConfig) super.mo6003with(dateFormat);
        if (dateFormat == null) {
    ...
    public PrettyPrinter constructDefaultPrettyPrinter() {
        ...
        return prettyPrinter instanceof Instantiatable ? (PrettyPrinter) ((Instantiatable) prettyPrinter).mo5977createInstance() : prettyPrinter;
    }
    ...
    public <T extends BeanDescription> T introspect(JavaType javaType) {
        return (T) getClassIntrospector().mo6078forSerialization(this, javaType, this);
    }
}
