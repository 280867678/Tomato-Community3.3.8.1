...
public abstract class DelegatingDeserializer extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer {
    ...
    public Object mo6063deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        return this._delegatee.mo6063deserialize(jsonParser, deserializationContext);
    }
    ...
    public Object mo6059deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) throws IOException {
        return this._delegatee.mo6059deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
    }
    ...
    public Object mo6027getNullValue(DeserializationContext deserializationContext) throws JsonMappingException {
        return this._delegatee.mo6027getNullValue(deserializationContext);
    }
