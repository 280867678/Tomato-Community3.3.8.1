...
public class SimpleType extends TypeBase {
    ...
    public SimpleType mo6169withTypeHandler(Object obj) {
    ...
    public SimpleType mo6170withValueHandler(Object obj) {
    ...
    public SimpleType mo6167withContentValueHandler(Object obj) {
        throw new IllegalArgumentException("Simple types have no content types; cannot call withContenValueHandler()");
    }

    @Override // com.fasterxml.jackson.databind.JavaType
    /* renamed from: withStaticTyping  reason: collision with other method in class */
    public SimpleType mo6168withStaticTyping() {
    ...
    protected String buildCanonicalName() {
        ...
        if (size > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                sb.append(mo6171containedType.toCanonical());
            }
            sb.append('>');
        }
        return sb.toString();
    ...
    public StringBuilder getGenericSignature(StringBuilder sb) {
        ...
        if (size > 0) {
            sb.append('<');
            for (int i = 0; i < size; i++) {
                sb = mo6171containedType(i).getGenericSignature(sb);
            }
            sb.append('>');
        }
        sb.append(';');
