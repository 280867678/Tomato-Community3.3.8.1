...
public final class TypeWrappedDeserializer extends JsonDeserializer<Object> implements Serializable {
    ...
    public Object mo6027getNullValue(DeserializationContext deserializationContext) throws JsonMappingException {
        return this._deserializer.mo6027getNullValue(deserializationContext);
    }
    ...
    public Object mo6063deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        return this._deserializer.mo6059deserializeWithType(jsonParser, deserializationContext, this._typeDeserializer);
    }
