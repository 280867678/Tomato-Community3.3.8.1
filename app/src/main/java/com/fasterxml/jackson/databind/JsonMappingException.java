...
public class JsonMappingException extends JsonProcessingException {
    ...
    public static JsonMappingException wrapWithPath(Throwable th, Reference reference) {
        ...
        if (th instanceof JsonMappingException) {
            ...
            if (th instanceof JsonProcessingException) {
                Object mo5968getProcessor = ((JsonProcessingException) th).mo5968getProcessor();
                if (mo5968getProcessor instanceof Closeable) {
                    closeable = (Closeable) mo5968getProcessor;
                }
            }
    ...
    public Object mo5968getProcessor() {
