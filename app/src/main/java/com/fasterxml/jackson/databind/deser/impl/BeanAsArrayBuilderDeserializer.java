...
public class BeanAsArrayBuilderDeserializer extends BeanDeserializerBase {
    ...
    public BeanDeserializerBase mo6012withObjectIdReader(ObjectIdReader objectIdReader) {
        return new BeanAsArrayBuilderDeserializer(this._delegate.mo6012withObjectIdReader(objectIdReader), this._targetType, this._orderedProperties, this._buildMethod);
    }

    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    /* renamed from: withIgnorableProperties */
    public BeanDeserializerBase mo6011withIgnorableProperties(Set<String> set) {
        return new BeanAsArrayBuilderDeserializer(this._delegate.mo6011withIgnorableProperties(set), this._targetType, this._orderedProperties, this._buildMethod);
    }
    ...
    protected final Object finishBuild(DeserializationContext deserializationContext, Object obj) throws IOException {
        try {
            return this._buildMethod.mo6070getMember().invoke(obj, null);
        } catch (Exception e) {
