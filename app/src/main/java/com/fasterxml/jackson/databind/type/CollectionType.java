...
public final class CollectionType extends CollectionLikeType {
    ...
    public CollectionType mo6169withTypeHandler(Object obj) {
    ...
    public CollectionType mo6162withContentTypeHandler(Object obj) {
        return new CollectionType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType.mo6169withTypeHandler(obj), this._valueHandler, this._typeHandler, this._asStatic);
    }

    @Override // com.fasterxml.jackson.databind.type.CollectionLikeType, com.fasterxml.jackson.databind.JavaType
    /* renamed from: withValueHandler */
    public CollectionType mo6170withValueHandler(Object obj) {
    ...
    public CollectionType mo6167withContentValueHandler(Object obj) {
        return new CollectionType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType.mo6170withValueHandler(obj), this._valueHandler, this._typeHandler, this._asStatic);
    }

    @Override // com.fasterxml.jackson.databind.type.CollectionLikeType, com.fasterxml.jackson.databind.JavaType
    /* renamed from: withStaticTyping */
    public CollectionType mo6168withStaticTyping() {
        return this._asStatic ? this : new CollectionType(this._class, this._bindings, this._superClass, this._superInterfaces, this._elementType.mo6168withStaticTyping(), this._valueHandler, this._typeHandler, true);
    }
