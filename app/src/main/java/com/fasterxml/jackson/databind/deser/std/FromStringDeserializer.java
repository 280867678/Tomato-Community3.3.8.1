...
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    public abstract T mo6062_deserialize(String str, DeserializationContext deserializationContext) throws IOException;
    ...
    public T mo6063deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (valueAsString != null) {
            if (valueAsString.length() != 0) {
                ...
                if (trim.length() != 0) {
                    try {
                        return mo6062_deserialize(trim, deserializationContext);
    ...
    public static class Std extends FromStringDeserializer<Object> {
        ...
        /* renamed from: _deserialize */
        protected Object mo6062_deserialize(String str, DeserializationContext deserializationContext) throws IOException {
            switch (this._kind) {
                case 1:
                    return new File(str);
                case 2:
