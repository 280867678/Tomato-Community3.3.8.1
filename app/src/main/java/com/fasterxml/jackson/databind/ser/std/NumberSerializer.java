...
public class NumberSerializer extends StdScalarSerializer<Number> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        return (findFormatOverrides == null || C13991.$SwitchMap$com$fasterxml$jackson$annotation$JsonFormat$Shape[findFormatOverrides.getShape().ordinal()] != 1) ? this : ToStringSerializer.instance;
    }

    /* renamed from: com.fasterxml.jackson.databind.ser.std.NumberSerializer$1 */
    /* loaded from: classes2.dex */
    static /* synthetic */ class C13991 {
