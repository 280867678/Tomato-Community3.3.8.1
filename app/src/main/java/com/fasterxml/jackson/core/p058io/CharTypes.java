...
public final class CharTypes {
    ...
    /* renamed from: HB */
    private static final byte[] f1273HB;

    /* renamed from: HC */
    private static final char[] f1274HC = "0123456789ABCDEF".toCharArray();
    ...
    static {
        int length = f1274HC.length;
        f1273HB = new byte[length];
        for (int i = 0; i < length; i++) {
            f1273HB[i] = (byte) f1274HC[i];
        }
        ...
        for (int i = 0; i < length2; i++) {
            ...
            if (charAt >= length || iArr[charAt] == 0) {
                ...
                if (i2 < 0) {
                    ...
                    sb.append('0');
                    sb.append('0');
                    sb.append(f1274HC[charAt >> 4]);
                    sb.append(f1274HC[charAt & 15]);
                } else {
                    sb.append((char) i2);
                }
            }
    ...
    public static char[] copyHexChars() {
        return (char[]) f1274HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f1273HB.clone();
    }
}
