...
/* renamed from: com.tomatolive.library.ui.view.widget.matisse.internal.model.SelectedItemCollection */
...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        ...
        if (maxSelectableReached()) {
            ...
            try {
                string = this.mContext.getString(R$string.fq_matisse_error_over_count, Integer.valueOf(currentMaxSelectable));
