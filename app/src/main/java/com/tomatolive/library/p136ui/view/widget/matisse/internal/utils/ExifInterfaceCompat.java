...
/* renamed from: com.tomatolive.library.ui.view.widget.matisse.internal.utils.ExifInterfaceCompat */
...
final class ExifInterfaceCompat {
    ...
    private static Date getExifDateTime(String str) {
        try {
            String attribute = newInstance(str).getAttribute(android.support.media.ExifInterface.TAG_DATETIME);
