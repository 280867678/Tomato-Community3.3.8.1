...
/* renamed from: com.tomatolive.library.ui.view.widget.CircleImageView */
...
public class CircleImageView extends AppCompatImageView {
    ...
    private void setBorderColor(@ColorInt int i) {
    ...
    private void setCircleBackgroundColor(@ColorInt int i) {
    ...
    private void setCircleBackgroundColorResource(@ColorRes int i) {
    ...
    @RequiresApi(api = 21)
    /* renamed from: com.tomatolive.library.ui.view.widget.CircleImageView$OutlineProvider */
    /* loaded from: classes4.dex */
