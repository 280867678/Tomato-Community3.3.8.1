...
/* renamed from: com.tomatolive.library.ui.view.widget.matisse.internal.ui.BasePreviewActivity */
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, OnFragmentInteractionListener {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.mCheckView.setOnClickListener(new View.OnClickListener() { // from class: com.tomatolive.library.ui.view.widget.matisse.internal.ui.BasePreviewActivity.1
        ...
        this.mOriginalLayout.setOnClickListener(new View.OnClickListener() { // from class: com.tomatolive.library.ui.view.widget.matisse.internal.ui.BasePreviewActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                int countOverMaxSize = BasePreviewActivity.this.countOverMaxSize();
                if (countOverMaxSize > 0) {
                    IncapableDialog.newInstance("", BasePreviewActivity.this.getString(R$string.fq_matisse_error_over_original_count, new Object[]{Integer.valueOf(countOverMaxSize), Integer.valueOf(BasePreviewActivity.this.mSpec.originalMaxSize)})).show(BasePreviewActivity.this.getSupportFragmentManager(), IncapableDialog.class.getName());
                    return;
                }
                BasePreviewActivity basePreviewActivity = BasePreviewActivity.this;
    ...
    @Override // com.tomatolive.library.p136ui.view.widget.matisse.listener.OnFragmentInteractionListener
    public void onClick() {
