...
/* renamed from: com.tomatolive.library.ui.view.widget.tagview.ColorFactory */
...
public class ColorFactory {
    ...
    /* renamed from: com.tomatolive.library.ui.view.widget.tagview.ColorFactory$PURE_COLOR */
    /* loaded from: classes4.dex */
    ...
    public static int[] onRandomBuild() {
        ...
        int parseColor = Color.parseColor("#33" + COLORS[random]);
        return new int[]{parseColor, Color.parseColor("#88" + COLORS[random]), SHARP666666, SHARP727272};
    }
    ...
    public static int[] onPureBuild(PURE_COLOR pure_color) {
        ...
        return new int[]{parseColor, Color.parseColor("#88" + str), SHARP727272, SHARP666666};
    }
}
