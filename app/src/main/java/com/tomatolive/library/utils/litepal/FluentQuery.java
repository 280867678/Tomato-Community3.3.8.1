...
public class FluentQuery {
    ...
    public <T> FindMultiExecutor<T> findAsync(final Class<T> cls, final boolean z) {
        ...
        findMultiExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.1
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final List find = FluentQuery.this.find(cls, z);
                    if (findMultiExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.1.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public <T> FindExecutor<T> findFirstAsync(final Class<T> cls, final boolean z) {
        ...
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.2
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object findFirst = FluentQuery.this.findFirst(cls, z);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.2.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public <T> FindExecutor<T> findLastAsync(final Class<T> cls, final boolean z) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.3
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object findLast = FluentQuery.this.findLast(cls, z);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.3.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public CountExecutor countAsync(final String str) {
        ...
        countExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.4
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int count = FluentQuery.this.count(str);
                    if (countExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.4.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public AverageExecutor averageAsync(final String str, final String str2) {
        ...
        averageExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.5
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final double average = FluentQuery.this.average(str, str2);
                    if (averageExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.5.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public <T> FindExecutor<T> maxAsync(final String str, final String str2, final Class<T> cls) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.6
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object max = FluentQuery.this.max(str, str2, cls);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.6.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public <T> FindExecutor<T> minAsync(final String str, final String str2, final Class<T> cls) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.7
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object min = FluentQuery.this.min(str, str2, cls);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.7.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public <T> FindExecutor<T> sumAsync(final String str, final String str2, final Class<T> cls) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.8
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object sum = FluentQuery.this.sum(str, str2, cls);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.FluentQuery.8.1
                            @Override // java.lang.Runnable
                            public void run() {
