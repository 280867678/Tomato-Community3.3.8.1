...
import com.tomatolive.library.utils.litepal.crud.DeleteHandler;
...
import com.tomatolive.library.utils.litepal.crud.SaveHandler;
import com.tomatolive.library.utils.litepal.crud.UpdateHandler;
...
import com.tomatolive.library.utils.litepal.parser.LitePalParser;
...
public class Operator {
    ...
    public static CountExecutor countAsync(final String str) {
        ...
        countExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.1
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int count = Operator.count(str);
                    if (countExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.1.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static AverageExecutor averageAsync(final String str, final String str2) {
        ...
        averageExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.2
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final double average = Operator.average(str, str2);
                    if (averageExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.2.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindExecutor<T> maxAsync(final String str, final String str2, final Class<T> cls) {
        ...
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.3
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object max = Operator.max(str, str2, cls);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.3.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindExecutor<T> minAsync(final String str, final String str2, final Class<T> cls) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.4
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object min = Operator.min(str, str2, cls);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.4.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindExecutor<T> sumAsync(final String str, final String str2, final Class<T> cls) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.5
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object sum = Operator.sum(str, str2, cls);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.5.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindExecutor<T> findAsync(final Class<T> cls, final long j, final boolean z) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.6
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object find = Operator.find(cls, j, z);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.6.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindExecutor<T> findFirstAsync(final Class<T> cls, final boolean z) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.7
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object findFirst = Operator.findFirst(cls, z);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.7.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindExecutor<T> findLastAsync(final Class<T> cls, final boolean z) {
        final FindExecutor<T> findExecutor = new FindExecutor<>();
        findExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.8
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final Object findLast = Operator.findLast(cls, z);
                    if (findExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.8.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T> FindMultiExecutor<T> findAllAsync(final Class<T> cls, final boolean z, final long... jArr) {
        ...
        findMultiExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.9
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final List findAll = Operator.findAll(cls, z, jArr);
                    if (findMultiExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.9.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static UpdateOrDeleteExecutor deleteAsync(final Class<?> cls, final long j) {
        ...
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.10
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int delete = Operator.delete(cls, j);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.10.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static UpdateOrDeleteExecutor deleteAllAsync(final Class<?> cls, final String... strArr) {
        final UpdateOrDeleteExecutor updateOrDeleteExecutor = new UpdateOrDeleteExecutor();
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.11
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int deleteAll = Operator.deleteAll(cls, strArr);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.11.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static UpdateOrDeleteExecutor deleteAllAsync(final String str, final String... strArr) {
        final UpdateOrDeleteExecutor updateOrDeleteExecutor = new UpdateOrDeleteExecutor();
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.12
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int deleteAll = Operator.deleteAll(str, strArr);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.12.1
                            @Override // java.lang.Runnable
                            public void run() {
                                updateOrDeleteExecutor.getListener().onFinish(deleteAll);
                            }
    ...
    public static UpdateOrDeleteExecutor updateAsync(final Class<?> cls, final ContentValues contentValues, final long j) {
        final UpdateOrDeleteExecutor updateOrDeleteExecutor = new UpdateOrDeleteExecutor();
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.13
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int update = Operator.update(cls, contentValues, j);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.13.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static UpdateOrDeleteExecutor updateAllAsync(final String str, final ContentValues contentValues, final String... strArr) {
        final UpdateOrDeleteExecutor updateOrDeleteExecutor = new UpdateOrDeleteExecutor();
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.14
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int updateAll = Operator.updateAll(str, contentValues, strArr);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.14.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public static <T extends LitePalSupport> SaveExecutor saveAllAsync(final Collection<T> collection) {
        ...
        saveExecutor.submit(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.15
            @Override // java.lang.Runnable
            public void run() {
                final boolean z;
                synchronized (LitePalSupport.class) {
                    ...
                    if (saveExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.tomatolive.library.utils.litepal.Operator.15.1
                            @Override // java.lang.Runnable
                            public void run() {
