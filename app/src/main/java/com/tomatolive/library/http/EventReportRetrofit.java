...
import com.tomatolive.library.http.interceptor.GzipHeaderInterceptor;
...
public class EventReportRetrofit {
    ...
    private EventReportRetrofit() {
        ...
        try {
            ...
            builder.addInterceptor(new GzipHeaderInterceptor());
            builder.connectTimeout(6L, TimeUnit.SECONDS);
            builder.readTimeout(30L, TimeUnit.SECONDS);
            builder.writeTimeout(30L, TimeUnit.SECONDS);
            builder.sslSocketFactory(sslSocketFactory.sSLSocketFactory, sslSocketFactory.trustManager);
            builder.hostnameVerifier($$Lambda$EventReportRetrofit$3F2SM5e_EpoL_2LEJCOXC8L6zL8.INSTANCE);
