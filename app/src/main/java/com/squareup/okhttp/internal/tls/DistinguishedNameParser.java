...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f1886dn;
    private int end;
    private final int length;
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f1886dn = x500Principal.getName("RFC2253");
        this.length = this.f1886dn.length();
    }
    ...
    private String nextAT() {
        ...
        int i4 = this.pos;
        if (i4 >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f1886dn);
        }
        this.end = i4;
        if (this.chars[i4] == ' ') {
            while (true) {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f1886dn);
        }
        char c = this.chars[i];
        if (c >= '0' && c <= '9') {
            i2 = c - '0';
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f1886dn.toCharArray();
