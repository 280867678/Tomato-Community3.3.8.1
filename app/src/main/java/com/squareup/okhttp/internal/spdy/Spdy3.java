...
public final class Spdy3 implements Variant {
        ...
        public boolean nextFrame(FrameReader.Handler handler) throws IOException {
            ...
            try {
                ...
                if (!z2) {
                    ...
                    handler.data(z, i3, this.source, i2);
                    return true;
                }
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            ...
            int i3 = (z ? 1 : 0) | (z2 ? 2 : 0);
            this.sink.mo6810writeInt(-2147287039);
            this.sink.mo6810writeInt(((i3 & 255) << 24) | (size & ViewCompat.MEASURED_SIZE_MASK));
            this.sink.mo6810writeInt(i & Integer.MAX_VALUE);
            this.sink.mo6810writeInt(Integer.MAX_VALUE & i2);
            this.sink.mo6813writeShort(0);
        ...
        public synchronized void rstStream(int i, ErrorCode errorCode) throws IOException {
            ...
            this.sink.mo6810writeInt(-2147287037);
            this.sink.mo6810writeInt(8);
            this.sink.mo6810writeInt(i & Integer.MAX_VALUE);
            this.sink.mo6810writeInt(errorCode.spdyRstCode);
            this.sink.flush();
        }
        ...
        void sendDataFrame(int i, int i2, Buffer buffer, int i3) throws IOException {
            if (!this.closed) {
                ...
                this.sink.mo6810writeInt(i & Integer.MAX_VALUE);
                this.sink.mo6810writeInt(((i2 & 255) << 24) | (16777215 & i3));
                if (i3 <= 0) {
                    return;
                }
        ...
        private void writeNameValueBlockToBuffer(List<Header> list) throws IOException {
            ...
            this.headerBlockOut.mo6810writeInt(list.size());
            int size = list.size();
            for (int i = 0; i < size; i++) {
                ByteString byteString = list.get(i).name;
                this.headerBlockOut.mo6810writeInt(byteString.size());
                this.headerBlockOut.mo6804write(byteString);
                ByteString byteString2 = list.get(i).value;
                this.headerBlockOut.mo6810writeInt(byteString2.size());
                this.headerBlockOut.mo6804write(byteString2);
            }
        ...
        public synchronized void settings(Settings settings) throws IOException {
            ...
            this.sink.mo6810writeInt(-2147287036);
            this.sink.mo6810writeInt((((size * 8) + 4) & ViewCompat.MEASURED_SIZE_MASK) | 0);
            this.sink.mo6810writeInt(size);
            for (int i = 0; i <= 10; i++) {
                if (settings.isSet(i)) {
                    this.sink.mo6810writeInt(((settings.flags(i) & 255) << 24) | (i & ViewCompat.MEASURED_SIZE_MASK));
        ...
        public synchronized void ping(boolean z, int i, int i2) throws IOException {
            ...
            this.sink.mo6810writeInt(-2147287034);
            this.sink.mo6810writeInt(4);
        ...
        public synchronized void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
            ...
            this.sink.mo6810writeInt(-2147287033);
            this.sink.mo6810writeInt(8);
            this.sink.mo6810writeInt(i);
            this.sink.mo6810writeInt(errorCode.spdyGoAwayCode);
            this.sink.flush();
        }
        ...
        public synchronized void windowUpdate(int i, long j) throws IOException {
            ...
            this.sink.mo6810writeInt(-2147287031);
            this.sink.mo6810writeInt(8);
            this.sink.mo6810writeInt(i);
