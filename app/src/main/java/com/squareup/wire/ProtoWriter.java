...
public final class ProtoWriter {
    ...
    public void writeBytes(ByteString byteString) throws IOException {
        this.sink.mo6804write(byteString);
    }

    public void writeString(String str) throws IOException {
        this.sink.mo6814writeUtf8(str);
    }
    ...
    public void writeVarint32(int i) throws IOException {
        while ((i & (-128)) != 0) {
            this.sink.mo6807writeByte((i & 127) | 128);
            i >>>= 7;
        }
        this.sink.mo6807writeByte(i);
    }

    public void writeVarint64(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.sink.mo6807writeByte((((int) j) & 127) | 128);
            j >>>= 7;
        }
        this.sink.mo6807writeByte((int) j);
    }

    public void writeFixed32(int i) throws IOException {
        this.sink.mo6811writeIntLe(i);
    }

    public void writeFixed64(long j) throws IOException {
        this.sink.mo6812writeLongLe(j);
    }
}
