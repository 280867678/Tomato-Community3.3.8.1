...
public class RuntimeExceptionDao<T, ID> implements CloseableIterable<T> {
    public static final Log.Level LOG_LEVEL = Log.Level.DEBUG;
    public static final Logger logger = LoggerFactory.getLogger(RuntimeExceptionDao.class);
    public AbstractC2183Dao<T, ID> dao;

    public RuntimeExceptionDao(AbstractC2183Dao<T, ID> abstractC2183Dao) {
    ...
    public int delete(T t) {
        try {
            return this.dao.delete((AbstractC2183Dao<T, ID>) t);
        } catch (SQLException e) {
    ...
    public CloseableIterator<T> mo6330iterator() {
        return this.dao.mo6325iterator();
    }
    ...
    public int update(T t) {
        try {
            return this.dao.update((AbstractC2183Dao<T, ID>) t);
        } catch (SQLException e) {
