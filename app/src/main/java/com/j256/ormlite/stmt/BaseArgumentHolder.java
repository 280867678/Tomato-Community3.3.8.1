...
public abstract class BaseArgumentHolder implements ArgumentHolder {
    ...
    public Object getSqlArgValue() {
        ...
        return fieldType == null ? value : (!fieldType.isForeign() || this.fieldType.getType() != value.getClass()) ? this.fieldType.convertJavaFieldToSqlArgValue(value) : this.fieldType.getForeignIdField().extractJavaFieldValue(value);
    }
