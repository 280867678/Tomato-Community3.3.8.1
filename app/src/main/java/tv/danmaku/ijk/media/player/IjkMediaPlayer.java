...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    */
    ...
    public IjkTrackInfo[] mo6888getTrackInfo() {
        IjkMediaMeta parse;
            ...
            if (ijkMediaPlayer != null) {
                ...
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i == 1) {
                        ...
                        DebugLog.m7e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                        ...
                        DebugLog.m7e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                        return;
                    } else {
