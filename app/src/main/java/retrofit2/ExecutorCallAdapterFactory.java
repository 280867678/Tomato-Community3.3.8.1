...
public final class ExecutorCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
                    ...
                    ExecutorCallbackCall.this.callbackExecutor.execute(new Runnable() { // from class: retrofit2.ExecutorCallAdapterFactory.ExecutorCallbackCall.1.1
                        ...
                        public void run() {
                            if (ExecutorCallbackCall.this.delegate.isCanceled()) {
                                C55641 c55641 = C55641.this;
                                callback.onFailure(ExecutorCallbackCall.this, new IOException("Canceled"));
                                return;
                            }
                            C55641 c556412 = C55641.this;
        ...
        public Call<T> mo6882clone() {
            return new ExecutorCallbackCall(this.callbackExecutor, this.delegate.mo6882clone());
        }
    }
}
