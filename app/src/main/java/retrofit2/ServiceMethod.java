        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (Iterable.class.isAssignableFrom(rawType5)) {
                    ...
                    return new ParameterHandler.Field(value4, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType5.getComponentType()), annotationArr), encoded3).array();
                } else {
                ...
                Converter<T, String> stringConverter = this.retrofit.stringConverter(Utils.getParameterUpperBound(1, parameterizedType2), annotationArr);
                this.gotField = true;
                ...
                if (Iterable.class.isAssignableFrom(rawType7)) {
                    ...
                    return new ParameterHandler.Part(m72of, this.retrofit.requestBodyConverter(parameterUpperBound3, annotationArr, this.methodAnnotations)).iterable();
                } else if (rawType7.isArray()) {
