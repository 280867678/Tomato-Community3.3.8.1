...
public final class ObservableRepeatWhen<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    protected void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource<?> mo6755apply = this.handler.mo6755apply(serialized);
            ObjectHelper.requireNonNull(mo6755apply, "The handler returned a null ObservableSource");
            ObservableSource<?> observableSource = mo6755apply;
