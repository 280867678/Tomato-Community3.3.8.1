    ...
    static final class LatestCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                Object[] mo6754poll = spscLinkedArrayQueue.mo6754poll();
                boolean z3 = mo6754poll == null;
                if (z2 && z3) {
                    clear(spscLinkedArrayQueue);
                    ...
                    try {
                        Object obj = (R) this.combiner.mo6755apply(mo6754poll);
                        ObjectHelper.requireNonNull(obj, "The combiner returned a null value");
                        observer.onNext(obj);
                    } catch (Throwable th) {
