            ...
            while (true) {
                ...
                for (ZipObserver<T, R> zipObserver : zipObserverArr) {
                    if (tArr[i3] == null) {
                        ...
                        T mo6754poll = zipObserver.queue.mo6754poll();
                ...
                if (i2 == 0) {
                    try {
                        Object obj = (R) this.zipper.mo6755apply(tArr.clone());
                        ObjectHelper.requireNonNull(obj, "The zipper returned a null value");
                        observer.onNext(obj);
