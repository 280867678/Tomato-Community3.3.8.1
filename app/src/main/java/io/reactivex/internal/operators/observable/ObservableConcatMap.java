                ...
                if (!this.active) {
                    ...
                    try {
                        ...
                        if (z && z2) {
                            ...
                            try {
                                ObservableSource<? extends U> mo6755apply = this.mapper.mo6755apply(mo6754poll);
            ...
            while (true) {
                if (!this.active) {
                    if (this.cancelled) {
                        ...
                        boolean z = this.done;
                        try {
                            T mo6754poll = simpleQueue.mo6754poll();
                            boolean z2 = mo6754poll == null;
                            if (z && z2) {
                                this.cancelled = true;
                                ...
                                try {
                                    ObservableSource<? extends R> mo6755apply = this.mapper.mo6755apply(mo6754poll);
                                    ObjectHelper.requireNonNull(mo6755apply, "The mapper returned a null ObservableSource");
