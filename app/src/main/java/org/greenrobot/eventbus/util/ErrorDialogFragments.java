...
public class ErrorDialogFragments {
    ...
    public static Dialog createDialog(Context context, Bundle bundle, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setTitle(bundle.getString(de.greenrobot.event.util.ErrorDialogManager.KEY_TITLE));
        builder.setMessage(bundle.getString(de.greenrobot.event.util.ErrorDialogManager.KEY_MESSAGE));
    ...
    public static void handleOnClick(DialogInterface dialogInterface, int i, Activity activity, Bundle bundle) {
        ...
        } else if (!bundle.getBoolean(de.greenrobot.event.util.ErrorDialogManager.KEY_FINISH_AFTER_DIALOG, false) || activity == null) {
        } else {
            activity.finish();
        }
    }
    ...
    /* loaded from: classes4.dex */
    public static class Support extends android.support.p002v4.app.DialogFragment implements DialogInterface.OnClickListener {
