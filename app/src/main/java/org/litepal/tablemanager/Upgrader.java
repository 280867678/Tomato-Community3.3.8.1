...
public class Upgrader extends AssociationUpdater {
    ...
    public void createOrUpgradeTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        for (TableModel tableModel : getAllTableModels()) {
            ...
            LitePalLog.m48d("AssociationUpdater", "createOrUpgradeTable: model is " + this.mTableModel.getTableName());
            upgradeTable();
        }
    }
    ...
    private List<String> findColumnsToRemove() {
        ...
        LitePalLog.m48d("AssociationUpdater", "remove columns from " + tableName + " >> " + arrayList);
        return arrayList;
    }
            ...
            for (ColumnModel columnModel2 : this.mTableModel.getColumnModels()) {
                if (columnModel.getColumnName().equalsIgnoreCase(columnModel2.getColumnName())) {
                    ...
                    if (!this.hasConstraintChanged) {
                        LitePalLog.m48d("AssociationUpdater", "default value db is:" + columnModel.getDefaultValue() + ", default value is:" + columnModel2.getDefaultValue());
    ...
    private void removeColumns(List<String> list) {
        LitePalLog.m48d("AssociationUpdater", "do removeColumns " + list);
    ...
    private void addColumns(List<ColumnModel> list) {
        LitePalLog.m48d("AssociationUpdater", "do addColumn");
    ...
    private void changeColumnsType(List<ColumnModel> list) {
        LitePalLog.m48d("AssociationUpdater", "do changeColumnsType");
        ArrayList arrayList = new ArrayList();
    ...
    private void changeColumnsConstraints() {
        if (this.hasConstraintChanged) {
            LitePalLog.m48d("AssociationUpdater", "do changeColumnsConstraints");
    ...
    private List<String> getChangeColumnsConstraintsSQL() {
        ...
        LitePalLog.m48d("AssociationUpdater", "generateChangeConstraintSQL >> ");
        for (String str : arrayList) {
            LitePalLog.m48d("AssociationUpdater", str);
        }
        LitePalLog.m48d("AssociationUpdater", "<< generateChangeConstraintSQL");
        return arrayList;
    }
