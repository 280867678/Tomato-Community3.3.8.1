...
public class DOMElement extends DefaultElement implements Element {
    ...
    public Attr getAttributeNode(String str) {
        return DOMNodeHelper.asDOMAttr(mo6817attribute(str));
    }
    ...
    public boolean hasAttribute(String str) {
        return mo6817attribute(str) != null;
    }
    ...
    protected Attribute attribute(Attr attr) {
        return mo6818attribute(DOCUMENT_FACTORY.createQName(attr.getLocalName(), attr.getPrefix(), attr.getNamespaceURI()));
    }
