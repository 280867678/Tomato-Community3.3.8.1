...
public class Mode {
    ...
    public Rule getMatchingRule(Node node) {
        ...
        if (nodeType == 1) {
            if (this.elementNameRuleSets != null) {
                RuleSet ruleSet2 = this.elementNameRuleSets.get(node.getName());
            ...
            RuleSet ruleSet3 = this.attributeNameRuleSets.get(node.getName());
        ...
        return (rule != null || nodeType == 0 || (ruleSet = this.ruleSets[0]) == null) ? rule : ruleSet.getMatchingRule(node);
    }
    ...
    protected Map<String, RuleSet> addToNameMap(Map<String, RuleSet> map, String str, Rule rule) {
        if (map == null) {
            map = new HashMap<>();
        }
    ...
    protected void removeFromNameMap(Map<String, RuleSet> map, String str, Rule rule) {
        RuleSet ruleSet;
        if (map == null || (ruleSet = map.get(str)) == null) {
            return;
        }
