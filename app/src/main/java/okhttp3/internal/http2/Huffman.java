...
class Huffman {
    ...
    public void encode(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        ...
        while (i < byteString.size()) {
            ...
            while (i4 >= 8) {
                i4 = (i4 == 1 ? 1 : 0) - 8;
                bufferedSink.mo6807writeByte((int) (j >> i4));
            }
            i++;
            b = i4;
        }
        if (b > 0) {
            bufferedSink.mo6807writeByte((int) ((255 >>> b) | (j << (8 - b))));
        }
    }
